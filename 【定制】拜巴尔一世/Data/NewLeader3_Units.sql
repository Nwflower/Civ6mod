...
SELECT 'UNIT_NW011',                 -- 类型
       ...
       'LOC_UNIT_NW011_DESCRIPTION', -- 描述文本
       Flavor,
       CanCapture,                                -- 可以俘虏平民单位
       CanRetreatWhenCaptured,                    -- 被俘虏时传送回最近城市
       'TRAIT_UNIT_NW011',           -- 绑定特性
