--	FILE: CIVILIZATION_GUMOON_Unit.sql
--  VERSION: 1
--  Author: Nwflower
--  Spicial Thanks: Uni
--	Copyright (c) 2025.
...
SELECT 'UNIT_NW_250924',                 -- 类型
       'LOC_UNIT_NW_250924_NAME',        -- 名称
       BaseSightRange,                            --视野
       BaseMoves,                                 -- 移动力
       Combat,                                    -- 近战力
       RangedCombat,                              -- 远程力
       ...
       'LOC_UNIT_NW_250924_DESCRIPTION', -- 描述文本
       Flavor,
       CanCapture,                                -- 可以俘虏平民单位
       CanRetreatWhenCaptured,                    -- 被俘虏时传送回最近城市
       'TRAIT_UNIT_NW_250924',           -- 绑定特性
...
INSERT INTO Improvement_ValidBuildUnits(ImprovementType, UnitType, ConsumesCharge, ValidRepairOnly) SELECT
ImprovementType, 'UNIT_NW_250924', ConsumesCharge, ValidRepairOnly
...
--============================================================
INSERT INTO Types (Type, Kind)
VALUES ('ABILITY_NW_250924', 'KIND_ABILITY');

INSERT INTO Tags(Tag, Vocabulary)
VALUES ('CLASS_NW_250924', 'ABILITY_CLASS');

INSERT INTO TypeTags (Type, Tag)
VALUES ('ABILITY_NW_250924', 'CLASS_NW_250924'),
       ('UNIT_NW_250924', 'CLASS_NW_250924');

INSERT INTO UnitAbilities (UnitAbilityType, Description)
VALUES ('ABILITY_NW_250924', 'LOC_ABILITY_NW_250924');

INSERT INTO UnitAbilityModifiers (UnitAbilityType, ModifierId)
VALUES ('ABILITY_NW_250924', 'MODFEAT_NW_250924_PROPERTY');

INSERT INTO Modifiers (ModifierId, ModifierType)
VALUES ('MODFEAT_NW_250924_PROPERTY', 'MODIFIER_UNIT_ADJUST_PROPERTY');

INSERT INTO ModifierArguments (ModifierId, Name, Value)
VALUES ('MODFEAT_NW_250924_PROPERTY', 'Key', 'PROPERTY_EARTHENGINEER_RANDOM_RESOURCE'),
       ('MODFEAT_NW_250924_PROPERTY', 'Amount', 1);
...
WHERE r.ResourceClassType = 'RESOURCECLASS_BONUS' OR r.ResourceClassType = 'RESOURCECLASS_LUXURY';
