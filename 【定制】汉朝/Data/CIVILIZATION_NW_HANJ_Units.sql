--	FILE: CIVILIZATION_NW_HANJ_Unit.sql
--  VERSION: 1
--  Author: Nwflower
--  Spicial Thanks: Uni
--	Copyright (c) 2025.
...
SELECT 'UNIT_NW_YULIN',                 -- 类型
       'LOC_UNIT_NW_YULIN_NAME',        -- 名称
       BaseSightRange,                            --视野
       BaseMoves,                                 -- 移动力
       52,                                    -- 近战力
       RangedCombat,                              -- 远程力
       ...
       'LOC_UNIT_NW_YULIN_DESCRIPTION', -- 描述文本
       Flavor,
       CanCapture,                                -- 可以俘虏平民单位
       CanRetreatWhenCaptured,                    -- 被俘虏时传送回最近城市
       'TRAIT_UNIT_NW_YULIN',           -- 绑定特性
...
('TRAIT_CIVILIZATION_CIV_HANJ_NW003', 'MODIFIER_UNIT_NW_YULIN_ADJUST_COMBAT_STRENGTH');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
('MODIFIER_UNIT_NW_YULIN_ADJUST_COMBAT_STRENGTH', 'MODIFIER_PLAYER_UNITS_ADJUST_COMBAT_STRENGTH', 0, 0, 0, NULL, 'REQS_MODIFIER_UNIT_NW_YULIN_ADJUST_COMBAT_STRENGTH');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
('MODIFIER_UNIT_NW_YULIN_ADJUST_COMBAT_STRENGTH', 'Amount', '5');
INSERT INTO ModifierStrings (ModifierId, Context, Text) VALUES
('MODIFIER_UNIT_NW_YULIN_ADJUST_COMBAT_STRENGTH', 'Preview', 'LOC_MODIFIER_UNIT_NW_YULIN_ADJUST_COMBAT_STRENGTH');


-- RequirementSets
INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES
('REQS_MODIFIER_UNIT_NW_YULIN_ADJUST_COMBAT_STRENGTH', 'REQUIREMENTSET_TEST_ALL');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
('REQS_MODIFIER_UNIT_NW_YULIN_ADJUST_COMBAT_STRENGTH', 'REQ_MODIFIER_UNIT_NW_YULIN_ADJUST_COMBAT_STRENGTH'),
('REQS_MODIFIER_UNIT_NW_YULIN_ADJUST_COMBAT_STRENGTH', 'REQ_MODIFIER_UNIT_NW_YULIN_ADJUST_COMBAT_STRENGTH2');

-- Requirements
INSERT INTO Requirements (RequirementId, RequirementType, Inverse) VALUES
('REQ_MODIFIER_UNIT_NW_YULIN_ADJUST_COMBAT_STRENGTH', 'REQUIREMENT_UNIT_TYPE_MATCHES', 0),
('REQ_MODIFIER_UNIT_NW_YULIN_ADJUST_COMBAT_STRENGTH2', 'REQUIREMENT_PLOT_NEARBY_UNIT_TAG_MATCHES', 1);
INSERT INTO RequirementArguments (RequirementId, Name, Value) VALUES
('REQ_MODIFIER_UNIT_NW_YULIN_ADJUST_COMBAT_STRENGTH', 'UnitType', 'UNIT_NW_YULIN'),
('REQ_MODIFIER_UNIT_NW_YULIN_ADJUST_COMBAT_STRENGTH2', 'MaxDistance', '1'),
('REQ_MODIFIER_UNIT_NW_YULIN_ADJUST_COMBAT_STRENGTH2', 'MinDistance', '0'),
('REQ_MODIFIER_UNIT_NW_YULIN_ADJUST_COMBAT_STRENGTH2', 'Tag', 'CLASS_ALL_UNITS');



-- 刘彻特色单位，替代追猎者，拥有更高的基础花费。掠夺农田、牧场和营地改良设施后回复50血量。可以使用自身的高 [ICON_MOVEMENT] 移动力护送平民单位。

-- 单位基础类型、标签、分类
INSERT INTO Types(Type, Kind)
VALUES ('UNIT_NW_BIAOQI', 'KIND_UNIT');

INSERT INTO TypeTags(Type, Tag)
SELECT 'UNIT_NW_BIAOQI', Tag
FROM TypeTags
WHERE Type = 'UNIT_COURSER';

INSERT INTO UnitAiInfos(UnitType, AiType)
SELECT 'UNIT_NW_BIAOQI', AiType
FROM UnitAiInfos
WHERE UnitType = 'UNIT_COURSER';

-- 单位是否替代原型单位
INSERT INTO UnitReplaces (civuniqueunittype, replacesunittype)
VALUES ('UNIT_NW_BIAOQI', 'UNIT_COURSER');
...
INSERT INTO Units(UnitType, Name, BaseSightRange, BaseMoves, Combat, RangedCombat, Range, Bombard, Domain,
                  ...
                  MandatoryObsoleteCivic, AdvisorType, EnabledByReligion, TrackReligion, DisasterCharges,
                  UseMaxMeleeTrainedStrength, ImmediatelyName, CanEarnExperience)
SELECT 'UNIT_NW_BIAOQI',                 -- 类型
       'LOC_UNIT_NW_BIAOQI_NAME',        -- 名称
       BaseSightRange,                            --视野
       BaseMoves,                                 -- 移动力
       48,                                    -- 近战力
       RangedCombat,                              -- 远程力
       ...
       ReligiousHealCharges,                      -- 宗教治疗次数
       ExtractsArtifacts,                         -- 是否可以挖掘文物。
       'LOC_UNIT_NW_BIAOQI_DESCRIPTION', -- 描述文本
       Flavor,
       CanCapture,                                -- 可以俘虏平民单位
       CanRetreatWhenCaptured,                    -- 被俘虏时传送回最近城市
       'TRAIT_UNIT_NW_BIAOQI',           -- 绑定特性
       AllowBarbarians,                           -- 允许蛮族生成
       CostProgressionModel,                      -- 涨价方式 NO_COST_PROGRESSION不涨价
       CostProgressionParam1,                     -- 涨价参数 COST_PROGRESSION_GAME_PROGRESS按游戏进程涨价 CostProgressionParam1填最终（即全科技/市政后的）价格百分比 COST_PROGRESSION_PREVIOUS_COPIES按已有数量涨价 CostProgressionParam1填每一个涨价的数量
       PromotionClass,                            -- 单位的晋升树，指向UnitPromotionClasses表的PromotionClassType列。
...
VALUES ('ABILITY_UNIT_NW_BIAOQI', 'KIND_ABILITY');

INSERT OR
REPLACE INTO Tags (Tag, Vocabulary)
VALUES ('CLASS_NW_BIAOQI', 'ABILITY_CLASS');
INSERT OR
REPLACE INTO TypeTags (Type, Tag)
VALUES ('UNIT_NW_BIAOQI', 'CLASS_NW_BIAOQI'),
       ('ABILITY_UNIT_NW_BIAOQI', 'CLASS_NW_BIAOQI');

INSERT OR
REPLACE INTO UnitAbilities(UnitAbilityType, Name, Description, Inactive)
VALUES ('ABILITY_UNIT_NW_BIAOQI',
        'LOC_ABILITY_UNIT_NW_BIAOQI_DESCRIPTION',
        'LOC_ABILITY_UNIT_NW_BIAOQI_DESCRIPTION',
        0);
INSERT OR
REPLACE INTO UnitAbilityModifiers(UnitAbilityType, ModifierId)
VALUES ('ABILITY_UNIT_NW_BIAOQI', 'ZHUGE_MUNIU_SHARED_MOVEMENT');
INSERT OR
REPLACE INTO Modifiers(ModifierId, ModifierType)
VALUES ('ZHUGE_MUNIU_SHARED_MOVEMENT', 'MODIFIER_UNIT_ADJUST_ESCORT_MOBILITY');
INSERT OR
REPLACE INTO ModifierArguments(ModifierId, Name, Value)
VALUES ('ZHUGE_MUNIU_SHARED_MOVEMENT', 'EscortMobility', 1);

-- 掠夺农田、牧场和营地改良设施后回复50血量。
