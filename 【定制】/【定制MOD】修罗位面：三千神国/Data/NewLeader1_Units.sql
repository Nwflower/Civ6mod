...
VALUES ('UNIT_ANYINQISHI', 'KIND_UNIT');

INSERT INTO TypeTags(Type, Tag)
SELECT 'UNIT_ANYINQISHI', Tag
FROM TypeTags
WHERE Type = 'UNIT_MONGOLIAN_KESHIG';

INSERT INTO UnitAiInfos(UnitType, AiType)
SELECT 'UNIT_ANYINQISHI', AiType
FROM UnitAiInfos
...
SELECT 'UNIT_ANYINQISHI',                 -- 类型
       'LOC_UNIT_ANYINQISHI_NAME',        -- 名称
       BaseSightRange,                            --视野
       6,                                 -- 移动力
       45,                                    -- 近战力
       50,                              -- 远程力
       ...
       'LOC_UNIT_ANYINQISHI_DESCRIPTION', -- 描述文本
       Flavor,
       CanCapture,                                -- 可以俘虏平民单位
       CanRetreatWhenCaptured,                    -- 被俘虏时传送回最近城市
       'TRAIT_UNIT_ANYINQISHI',           -- 绑定特性
       ...
       LeaderType,                                --
       CanTrain,                                  -- 可生产
       NULL,                         -- 生产单位消耗的战略资源，指向Resources表的ResourceType列。消耗的数量在Units_XP2表的ResourceCost列指定。
       PurchaseYield,                             -- 购买方式
       MustPurchase,                              -- 只能购买
       Maintenance,                               -- 维护费
