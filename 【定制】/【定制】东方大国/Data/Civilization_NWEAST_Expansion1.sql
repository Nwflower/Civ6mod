--	FILE: Civilization_NWEAST_Expansion1.sql
--  VERSION: 1
--  Author: Nwflower
--  Spicial Thanks: Uni
--	Copyright (c) 2025.
...
-- ('MOMENT_ILLUSTRATION_UNIQUE_UNIT','MOMENT_DATA_UNIT','PALACE','MomentSTK_Tagma.dds');


-- INSERT INTO District_Adjacencies(DistrictType,YieldChangeId)VALUES
-- ('DISTRICT_TIANCEFU','YieldChangeId1'),
-- ('DISTRICT_TIANCEFU','YieldChangeId2');
