...
SET Value = 0
WHERE ModifierId = 'STANDARD_DIPLOMATIC_DIFFERENT_SECRET_SOCIETY'
  AND Name = 'InitialValue';

-- 关系+20
INSERT INTO TraitModifiers (TraitType, ModifierId)
VALUES ('TRAIT_LEADER_MAJOR_CIV', 'TRAIT_LEADER_MAJOR_CIV_ADD_20');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId,
                       SubjectRequirementSetId)
VALUES ('TRAIT_LEADER_MAJOR_CIV_ADD_20', 'MODIFIER_PLAYER_DIPLOMACY_SIMPLE_MODIFIER', 1, 1, 0, NULL, NULL);
INSERT INTO ModifierArguments (ModifierId, Name, Value)
VALUES ('TRAIT_LEADER_MAJOR_CIV_ADD_20', 'InitialValue', '20'),
...
VALUES ('GOVERNOR_PROMOTION_OWLS_OF_MINERVA_1', 'MODIFIER_GOVERNOR_PROMOTION_OWLS_OF_MINERVA_1_MAOYIZHAN'),
...
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId,
                       SubjectRequirementSetId)
VALUES ('MODIFIER_GOVERNOR_PROMOTION_OWLS_OF_MINERVA_1_MAOYIZHAN', 'MODIFIER_PLAYER_ADJUST_IMMEDIATE_TRADING_POST', 0,
        0, 0, NULL, NULL);
INSERT INTO ModifierArguments (ModifierId, Name, Value)
VALUES ('MODIFIER_GOVERNOR_PROMOTION_OWLS_OF_MINERVA_1_MAOYIZHAN', 'ImmediateTradingPost', '1');
...
INSERT INTO NW_DIS_GP(DistrictType, GreatPersonClassType)
VALUES ('DISTRICT_CAMPUS', 'GREAT_PERSON_CLASS_SCIENTIST'),
...
INSERT INTO GovernorPromotionModifiers (GovernorPromotionType, ModifierId)
SELECT 'GOVERNOR_PROMOTION_HERMETIC_ORDER_3',
       'MODIFIER_GOVERNOR_PROMOTION_HERMETIC_ORDER_3_GPP_' || DistrictType
FROM NW_DIS_GP;
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId,
                       SubjectRequirementSetId)
SELECT 'MODIFIER_GOVERNOR_PROMOTION_HERMETIC_ORDER_3_GPP_' || DistrictType,
       'MODIFIER_PLAYER_DISTRICTS_ADJUST_GREAT_PERSON_POINTS',
       0,
       0,
       0,
       NULL,
       REPLACE(DistrictType, 'DISTRICT_', 'DISTRICT_IS_')
FROM NW_DIS_GP;
INSERT INTO ModifierArguments (ModifierId, Name, Value)
SELECT 'MODIFIER_GOVERNOR_PROMOTION_HERMETIC_ORDER_3_GPP_' || DistrictType,
       'Amount',
...
INSERT INTO GovernorPromotionModifiers (GovernorPromotionType, ModifierId)
VALUES ('GOVERNOR_PROMOTION_HERMETIC_ORDER_4', 'MODIFIER_GOVERNOR_PROMOTION_HERMETIC_ORDER_4_PRODUCTION');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId,
                       SubjectRequirementSetId)
VALUES ('MODIFIER_GOVERNOR_PROMOTION_HERMETIC_ORDER_4_PRODUCTION', 'MODIFIER_PLAYER_ADJUST_PLOT_YIELD', 0, 0, 0, NULL,
        'REQS_MODIFIER_GOVERNOR_PROMOTION_HERMETIC_ORDER_4_PRODUCTION');
INSERT INTO ModifierArguments (ModifierId, Name, Value)
VALUES ('MODIFIER_GOVERNOR_PROMOTION_HERMETIC_ORDER_4_PRODUCTION', 'Amount', '1'),
       ('MODIFIER_GOVERNOR_PROMOTION_HERMETIC_ORDER_4_PRODUCTION', 'YieldType', 'YIELD_PRODUCTION');

-- RequirementSets
INSERT INTO RequirementSets (RequirementSetId, RequirementSetType)
VALUES ('REQS_MODIFIER_GOVERNOR_PROMOTION_HERMETIC_ORDER_4_PRODUCTION', 'REQUIREMENTSET_TEST_ALL');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId)
VALUES ('REQS_MODIFIER_GOVERNOR_PROMOTION_HERMETIC_ORDER_4_PRODUCTION',
        'REQ_MODIFIER_GOVERNOR_PROMOTION_HERMETIC_ORDER_4_PRODUCTION');

-- Requirements
INSERT INTO Requirements (RequirementId, RequirementType)
VALUES ('REQ_MODIFIER_GOVERNOR_PROMOTION_HERMETIC_ORDER_4_PRODUCTION', 'REQUIREMENT_PLOT_RESOURCE_TYPE_MATCHES');
INSERT INTO RequirementArguments (RequirementId, Name, Value)
VALUES ('REQ_MODIFIER_GOVERNOR_PROMOTION_HERMETIC_ORDER_4_PRODUCTION', 'ResourceType', 'RESOURCE_LEY_LINE');
...
-- RequirementSets
INSERT INTO RequirementSets (RequirementSetId, RequirementSetType)
VALUES ('REQS_NW_CITY_HAS_1DIS', 'REQUIREMENTSET_TEST_ALL'),
...
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId)
VALUES ('REQS_NW_CITY_HAS_1DIS', 'REQ_NW_CITY_HAS_1DIS'),
...
-- Requirements
INSERT INTO Requirements (RequirementId, RequirementType)
VALUES ('REQ_NW_CITY_HAS_1DIS', 'REQUIREMENT_CITY_HAS_X_SPECIALTY_DISTRICTS'),
...
INSERT INTO RequirementArguments (RequirementId, Name, Value)
VALUES ('REQ_NW_CITY_HAS_1DIS', 'Amount', '1'),
...
INSERT INTO GovernorPromotionModifiers (GovernorPromotionType, ModifierId)
VALUES ('GOVERNOR_PROMOTION_VOIDSINGERS_1', 'MODIFIER_GOVERNOR_PROMOTION_VOIDSINGERS_4_BF_1');
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId)
VALUES ('MODIFIER_GOVERNOR_PROMOTION_VOIDSINGERS_4_BF_1', 'MODIFIER_PLAYER_CITIES_ADJUST_BUILDING_YIELD_CHANGE',
        'REQS_NW_CITY_HAS_1DIS');
INSERT INTO ModifierArguments (ModifierId, Name, Value)
VALUES ('MODIFIER_GOVERNOR_PROMOTION_VOIDSINGERS_4_BF_1', 'Amount', '1'),
...
INSERT INTO GovernorPromotionModifiers (GovernorPromotionType, ModifierId)
VALUES ('GOVERNOR_PROMOTION_VOIDSINGERS_1', 'MODIFIER_GOVERNOR_PROMOTION_VOIDSINGERS_4_BF_2');
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId)
VALUES ('MODIFIER_GOVERNOR_PROMOTION_VOIDSINGERS_4_BF_2', 'MODIFIER_PLAYER_CITIES_ADJUST_BUILDING_YIELD_CHANGE',
        'REQS_NW_CITY_HAS_2DIS');
INSERT INTO ModifierArguments (ModifierId, Name, Value)
VALUES ('MODIFIER_GOVERNOR_PROMOTION_VOIDSINGERS_4_BF_2', 'Amount', '1'),
...
INSERT INTO GovernorPromotionModifiers (GovernorPromotionType, ModifierId)
VALUES ('GOVERNOR_PROMOTION_VOIDSINGERS_1', 'MODIFIER_GOVERNOR_PROMOTION_VOIDSINGERS_4_BF_3');
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId)
VALUES ('MODIFIER_GOVERNOR_PROMOTION_VOIDSINGERS_4_BF_3', 'MODIFIER_PLAYER_CITIES_ADJUST_BUILDING_YIELD_CHANGE',
        'REQS_NW_CITY_HAS_3DIS');
INSERT INTO ModifierArguments (ModifierId, Name, Value)
VALUES ('MODIFIER_GOVERNOR_PROMOTION_VOIDSINGERS_4_BF_3', 'Amount', '1'),
...
INSERT INTO GovernorPromotionModifiers (GovernorPromotionType, ModifierId)
VALUES ('GOVERNOR_PROMOTION_VOIDSINGERS_1', 'MODIFIER_GOVERNOR_PROMOTION_VOIDSINGERS_4_BF_4');
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId)
VALUES ('MODIFIER_GOVERNOR_PROMOTION_VOIDSINGERS_4_BF_4', 'MODIFIER_PLAYER_CITIES_ADJUST_BUILDING_YIELD_CHANGE',
        'REQS_NW_CITY_HAS_4DIS');
INSERT INTO ModifierArguments (ModifierId, Name, Value)
VALUES ('MODIFIER_GOVERNOR_PROMOTION_VOIDSINGERS_4_BF_4', 'Amount', '1'),
...
INSERT INTO GovernorPromotionModifiers (GovernorPromotionType, ModifierId)
VALUES ('GOVERNOR_PROMOTION_VOIDSINGERS_1', 'MODIFIER_GOVERNOR_PROMOTION_VOIDSINGERS_4_BF_5');
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId)
VALUES ('MODIFIER_GOVERNOR_PROMOTION_VOIDSINGERS_4_BF_5', 'MODIFIER_PLAYER_CITIES_ADJUST_BUILDING_YIELD_CHANGE',
        'REQS_NW_CITY_HAS_5DIS');
INSERT INTO ModifierArguments (ModifierId, Name, Value)
VALUES ('MODIFIER_GOVERNOR_PROMOTION_VOIDSINGERS_4_BF_5', 'Amount', '1'),
...
INSERT INTO GovernorPromotionModifiers (GovernorPromotionType, ModifierId)
VALUES ('GOVERNOR_PROMOTION_VOIDSINGERS_1', 'MODIFIER_GOVERNOR_PROMOTION_VOIDSINGERS_4_GK');

INSERT INTO Modifiers (ModifierId, ModifierType)
VALUES ('MODIFIER_GOVERNOR_PROMOTION_VOIDSINGERS_4_GK', 'MODIFIER_NW_ETH_PLAYER_CAPITAL_ADJUST_EXTRA_GREAT_WORK_SLOTS');

INSERT INTO ModifierArguments (ModifierId, Name, Value)
VALUES ('MODIFIER_GOVERNOR_PROMOTION_VOIDSINGERS_4_GK', 'Amount', '4'),
...
VALUES ('MODIFIER_NW_ETH_PLAYER_CAPITAL_ADJUST_EXTRA_GREAT_WORK_SLOTS', 'KIND_MODIFIER');

INSERT INTO DynamicModifiers (ModifierType, CollectionType, EffectType)
VALUES ('MODIFIER_NW_ETH_PLAYER_CAPITAL_ADJUST_EXTRA_GREAT_WORK_SLOTS', 'COLLECTION_PLAYER_CAPITAL_CITY',
        'EFFECT_ADJUST_EXTRA_GREAT_WORK_SLOTS');

-- +10%信仰值
INSERT INTO GovernorPromotionModifiers (GovernorPromotionType, ModifierId)
VALUES ('GOVERNOR_PROMOTION_VOIDSINGERS_4', 'MODIFIER_GOVERNOR_PROMOTION_VOIDSINGERS_4_FAITH_BUFF');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId,
                       SubjectRequirementSetId)
VALUES ('MODIFIER_GOVERNOR_PROMOTION_VOIDSINGERS_4_FAITH_BUFF', 'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_MODIFIER', 0,
        0, 0, NULL, NULL);
INSERT INTO ModifierArguments (ModifierId, Name, Value)
VALUES ('MODIFIER_GOVERNOR_PROMOTION_VOIDSINGERS_4_FAITH_BUFF', 'Amount', '10'),
...
UPDATE Modifiers
SET SubjectRequirementSetId = 'REQS_NW_CITY_HAS_2DIS'
WHERE ModifierId = 'BUILDING_GILDED_VAULT_TRADE_ROUTE_CAPACITY';
...
-- 四级商路收益
INSERT INTO GovernorPromotionModifiers (GovernorPromotionType, ModifierId)
VALUES ('GOVERNOR_PROMOTION_OWLS_OF_MINERVA_4', 'MODIFIER_GOVERNOR_PROMOTION_OWLS_OF_MINERVA_4_TO_OTHER_CIV');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId,
                       SubjectRequirementSetId)
VALUES ('MODIFIER_GOVERNOR_PROMOTION_OWLS_OF_MINERVA_4_TO_OTHER_CIV',
        'MODIFIER_PLAYER_ADJUST_TRADE_ROUTE_YIELD_FOR_INTERNATIONAL', 0, 0, 0, NULL, NULL);
INSERT INTO ModifierArguments (ModifierId, Name, Value)
VALUES ('MODIFIER_GOVERNOR_PROMOTION_OWLS_OF_MINERVA_4_TO_OTHER_CIV', 'Amount', '2'),
       ('MODIFIER_GOVERNOR_PROMOTION_OWLS_OF_MINERVA_4_TO_OTHER_CIV', 'YieldType', 'YIELD_PRODUCTION');


INSERT INTO GovernorPromotionModifiers (GovernorPromotionType, ModifierId)
VALUES ('GOVERNOR_PROMOTION_OWLS_OF_MINERVA_4', 'MODIFIER_GOVERNOR_PROMOTION_OWLS_OF_MINERVA_4_TOSS');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId,
                       SubjectRequirementSetId)
VALUES ('MODIFIER_GOVERNOR_PROMOTION_OWLS_OF_MINERVA_4_TOSS',
        'MODIFIER_PLAYER_CITIES_ADJUST_CITY_STATE_TRADE_ROUTE_DISTRICT_YIELD', 0, 0, 0, NULL, NULL);
INSERT INTO ModifierArguments (ModifierId, Name, Value)
VALUES ('MODIFIER_GOVERNOR_PROMOTION_OWLS_OF_MINERVA_4_TOSS', 'Amount', '2'),
...
INSERT INTO TraitModifiers (TraitType, ModifierId)
VALUES ('TRAIT_LEADER_MAJOR_CIV', 'MODIFIER_UNITS_MOVEMENT_SETTLER_START_4');

INSERT INTO Modifiers(ModifierId, ModifierType, OwnerRequirementSetId, SubjectRequirementSetId)
VALUES ('MODIFIER_UNITS_MOVEMENT_SETTLER_START_4', 'MODIFIER_PLAYER_UNITS_ADJUST_MOVEMENT', 'PLAYER_IS_HUMAN',
        'TPBS_REQSET_Unit_Is_Settler_Turn_1');

INSERT INTO ModifierArguments (ModifierId, Name, Value)
VALUES ('MODIFIER_UNITS_MOVEMENT_SETTLER_START_4', 'Amount', '5');


-- 条件集

INSERT INTO RequirementSets (RequirementSetId, RequirementSetType)
VALUES ('TPBS_REQSET_Unit_Is_Settler_Turn_1', 'REQUIREMENTSET_TEST_ALL');

INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId)
VALUES ('TPBS_REQSET_Unit_Is_Settler_Turn_1', 'TPBS_REQ_UNIT_IS_SETTLER'),
...
VALUES ('TPBS_REQ_UNIT_IS_SETTLER', 'REQUIREMENT_UNIT_TYPE_MATCHES', 0),
       ('TPBS_REQ_TURN_1', 'REQUIREMENT_GAME_TURN_ATLEAST', 1);

INSERT INTO RequirementArguments (RequirementId, Name, Value)
VALUES ('TPBS_REQ_UNIT_IS_SETTLER', 'UnitType', 'UNIT_SETTLER'),
       ('TPBS_REQ_TURN_1', 'MinGameTurn', '4');



INSERT INTO TraitModifiers (TraitType, ModifierId)
VALUES ('TRAIT_LEADER_MAJOR_CIV', 'NW_Commercial_1_GRANT_ABILITY_NW_CB_UNIT_SETTLE');
INSERT INTO Modifiers (ModifierId, ModifierType, OwnerRequirementSetId)
VALUES ('NW_Commercial_1_GRANT_ABILITY_NW_CB_UNIT_SETTLE', 'MODIFIER_PLAYER_UNITS_GRANT_ABILITY', 'PLAYER_IS_HUMAN');
INSERT INTO ModifierArguments (ModifierId, Name, Value)
VALUES ('NW_Commercial_1_GRANT_ABILITY_NW_CB_UNIT_SETTLE', 'AbilityType', 'ABILITY_NW_CB_UNIT_SETTLE');
...
VALUES ('BUILDING_PALACE', 'MODIFIER_BUILDING_PALACE_4SCOUT');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId,
                       SubjectRequirementSetId)
VALUES ('MODIFIER_BUILDING_PALACE_4SCOUT', 'MODIFIER_PLAYER_GRANT_UNIT_IN_CAPITAL', 1, 1, 0, NULL, 'PLAYER_IS_HUMAN');
INSERT INTO ModifierArguments (ModifierId, Name, Value)
VALUES ('MODIFIER_BUILDING_PALACE_4SCOUT', 'AllowUniqueOverride', '1'),
       ('MODIFIER_BUILDING_PALACE_4SCOUT', 'Amount', '2'),
       ('MODIFIER_BUILDING_PALACE_4SCOUT', 'UnitType', 'UNIT_SCOUT');

-- 开局晋升
INSERT INTO BuildingModifiers (BuildingType, ModifierId)
VALUES ('BUILDING_PALACE', 'MODIFIER_BUILDING_PALACE_SCOUT_PROMOTION');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId,
                       SubjectRequirementSetId)
VALUES ('MODIFIER_BUILDING_PALACE_SCOUT_PROMOTION', 'MODIFIER_PLAYER_UNITS_ADJUST_GRANT_EXPERIENCE', 0, 0, 0,
        'PLAYER_IS_HUMAN', 'REQSET_MODIFIER_BUILDING_PALACE_SCOUT_PROMOTION');
INSERT INTO ModifierArguments (ModifierId, Name, Value)
VALUES ('MODIFIER_BUILDING_PALACE_SCOUT_PROMOTION', 'Amount', '-1');

-- RequirementSets
INSERT INTO RequirementSets (RequirementSetId, RequirementSetType)
VALUES ('REQSET_MODIFIER_BUILDING_PALACE_SCOUT_PROMOTION', 'REQUIREMENTSET_TEST_ALL');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId)
VALUES ('REQSET_MODIFIER_BUILDING_PALACE_SCOUT_PROMOTION', 'REQ_MODIFIER_BUILDING_PALACE_SCOUT_PROMOTION');

-- Requirements
INSERT INTO Requirements (RequirementId, RequirementType)
VALUES ('REQ_MODIFIER_BUILDING_PALACE_SCOUT_PROMOTION', 'REQUIREMENT_UNIT_TAG_MATCHES');
INSERT INTO RequirementArguments (RequirementId, Name, Value)
VALUES ('REQ_MODIFIER_BUILDING_PALACE_SCOUT_PROMOTION', 'Tag', 'CLASS_RECON');


-- 那烂陀
INSERT INTO TraitModifiers (TraitType, ModifierId)
VALUES ('TRAIT_LEADER_MAJOR_CIV', 'MODFEAT_IMPROVEMENT_MAHAVIHARA_GRANT_RANDOM_TECHNOLOGY');
INSERT INTO Modifiers (ModifierId, ModifierType, OwnerRequirementSetId, RunOnce, Permanent)
VALUES ('MODFEAT_IMPROVEMENT_MAHAVIHARA_GRANT_RANDOM_TECHNOLOGY', 'MODIFIER_PLAYER_GRANT_RANDOM_TECHNOLOGY',
        'REQSET_IMPROVEMENT_MAHAVIHARA1', 1, 1);
INSERT INTO ModifierArguments (ModifierId, Name, Value)
VALUES ('MODFEAT_IMPROVEMENT_MAHAVIHARA_GRANT_RANDOM_TECHNOLOGY', 'Amount', '1');
INSERT INTO TraitModifiers (TraitType, ModifierId)
VALUES ('TRAIT_LEADER_MAJOR_CIV', 'MODFEAT_IMPROVEMENT_MAHAVIHARA_GRANT_RANDOM_TECHNOLOGY2');
INSERT INTO Modifiers (ModifierId, ModifierType, OwnerRequirementSetId, RunOnce, Permanent)
VALUES ('MODFEAT_IMPROVEMENT_MAHAVIHARA_GRANT_RANDOM_TECHNOLOGY2', 'MODIFIER_PLAYER_GRANT_RANDOM_TECHNOLOGY',
        'REQSET_IMPROVEMENT_MAHAVIHARA2', 1, 1);
INSERT INTO ModifierArguments (ModifierId, Name, Value)
VALUES ('MODFEAT_IMPROVEMENT_MAHAVIHARA_GRANT_RANDOM_TECHNOLOGY2', 'Amount', '1');
INSERT INTO TraitModifiers (TraitType, ModifierId)
VALUES ('TRAIT_LEADER_MAJOR_CIV', 'MODFEAT_IMPROVEMENT_MAHAVIHARA_GRANT_RANDOM_TECHNOLOGY3');
INSERT INTO Modifiers (ModifierId, ModifierType, OwnerRequirementSetId, RunOnce, Permanent)
VALUES ('MODFEAT_IMPROVEMENT_MAHAVIHARA_GRANT_RANDOM_TECHNOLOGY3', 'MODIFIER_PLAYER_GRANT_RANDOM_TECHNOLOGY',
        'REQSET_IMPROVEMENT_MAHAVIHARA3', 1, 1);
INSERT INTO ModifierArguments (ModifierId, Name, Value)
VALUES ('MODFEAT_IMPROVEMENT_MAHAVIHARA_GRANT_RANDOM_TECHNOLOGY3', 'Amount', '1');


-- RequirementSets
INSERT INTO RequirementSets (RequirementSetId, RequirementSetType)
VALUES ('REQSET_IMPROVEMENT_MAHAVIHARA', 'REQUIREMENTSET_TEST_ALL'),
...
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId)
VALUES ('REQSET_IMPROVEMENT_MAHAVIHARA', 'REQ_IMPROVEMENT_MAHAVIHARA');
-- Requirements
INSERT INTO Requirements (RequirementId, RequirementType)
VALUES ('REQ_IMPROVEMENT_MAHAVIHARA', 'REQUIREMENT_PLOT_IMPROVEMENT_TYPE_MATCHES');
INSERT INTO RequirementArguments (RequirementId, Name, Value)
VALUES ('REQ_IMPROVEMENT_MAHAVIHARA', 'ImprovementType', 'IMPROVEMENT_MAHAVIHARA');

INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId)
VALUES ('REQSET_IMPROVEMENT_MAHAVIHARA1', 'REQ_IMPROVEMENT_MAHAVIHARA1');
INSERT INTO Requirements (RequirementId, RequirementType)
VALUES ('REQ_IMPROVEMENT_MAHAVIHARA1', 'REQUIREMENT_COLLECTION_COUNT_ATLEAST');
INSERT INTO RequirementArguments (RequirementId, Name, Value)
VALUES ('REQ_IMPROVEMENT_MAHAVIHARA1', 'CollectionType', 'COLLECTION_PLAYER_IMPROVEMENTS'),
       ('REQ_IMPROVEMENT_MAHAVIHARA1', 'Count', '1'),
       ('REQ_IMPROVEMENT_MAHAVIHARA1', 'RequirementSetId', 'REQSET_IMPROVEMENT_MAHAVIHARA');

INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId)
VALUES ('REQSET_IMPROVEMENT_MAHAVIHARA2', 'REQ_IMPROVEMENT_MAHAVIHARA2');
INSERT INTO Requirements (RequirementId, RequirementType)
VALUES ('REQ_IMPROVEMENT_MAHAVIHARA2', 'REQUIREMENT_COLLECTION_COUNT_ATLEAST');
INSERT INTO RequirementArguments (RequirementId, Name, Value)
VALUES ('REQ_IMPROVEMENT_MAHAVIHARA2', 'CollectionType', 'COLLECTION_PLAYER_IMPROVEMENTS'),
       ('REQ_IMPROVEMENT_MAHAVIHARA2', 'Count', '2'),
       ('REQ_IMPROVEMENT_MAHAVIHARA2', 'RequirementSetId', 'REQSET_IMPROVEMENT_MAHAVIHARA');

INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId)
VALUES ('REQSET_IMPROVEMENT_MAHAVIHARA3', 'REQ_IMPROVEMENT_MAHAVIHARA3');
INSERT INTO Requirements (RequirementId, RequirementType)
VALUES ('REQ_IMPROVEMENT_MAHAVIHARA3', 'REQUIREMENT_COLLECTION_COUNT_ATLEAST');
INSERT INTO RequirementArguments (RequirementId, Name, Value)
VALUES ('REQ_IMPROVEMENT_MAHAVIHARA3', 'CollectionType', 'COLLECTION_PLAYER_IMPROVEMENTS'),
...
DELETE
FROM TraitModifiers
WHERE ModifierId = 'MINOR_CIV_NALANDA_FREE_TECHNOLOGY'
  AND TraitType = 'MINOR_CIV_NALANDA_TRAIT';
...
INSERT OR
REPLACE INTO Feature_AdjacentYields
    (FeatureType, YieldType, YieldChange)
VALUES ('FEATURE_CERRO_DE_POTOSI', 'YIELD_FOOD', 1),
...
UPDATE ModifierArguments
SET Value = 2
WHERE ModifierId = 'MODIFIER_FEATURE_BIOLUMINESCENT_BAY_BOAT_SCIENCE'
  AND Name = 'Amount';
UPDATE ModifierArguments
SET Value = 3
WHERE ModifierId = 'MODIFIER_FEATURE_KAILASH_CULTURE_CITIES'
  AND Name = 'Amount';
UPDATE ModifierArguments
SET Value = 'YIELD_FAITH'
WHERE ModifierId = 'MODIFIER_FEATURE_KAILASH_CULTURE_CITIES'
  AND Name = 'YieldType';

INSERT OR
REPLACE INTO Feature_YieldChanges
    (FeatureType, YieldType, YieldChange)
VALUES ('FEATURE_BIOLUMINESCENT_BAY', 'YIELD_GOLD', 1),
...
UPDATE Governors
SET TransitionStrength = 125
WHERE TransitionStrength IS NOT NULL;
UPDATE Governors
SET TransitionStrength = TransitionStrength * 10000
WHERE GovernorType IS 'GOVERNOR_THE_AMBASSADOR';
-----------------------------------------------------------------------------------------------------------------
-- 梁左一改成马左一

-- GOVERNOR_PROMOTION_RESOURCE_MANAGER_EXPEDITION	给养保障
-- GOVERNOR_PROMOTION_REINFORCED_INFRASTRUCTURE	加固材料
UPDATE GovernorPromotionSets
SET GovernorType='GOVERNOR_THE_BUILDER'
WHERE GovernorPromotion = 'GOVERNOR_PROMOTION_RESOURCE_MANAGER_EXPEDITION';
...
DELETE
FROM GovernorPromotionPrereqs
WHERE GovernorPromotionType = 'GOVERNOR_PROMOTION_RESOURCE_MANAGER_EXPEDITION';
DELETE
FROM GovernorPromotionPrereqs
WHERE PrereqGovernorPromotion = 'GOVERNOR_PROMOTION_RESOURCE_MANAGER_EXPEDITION';
DELETE
FROM GovernorPromotionPrereqs
WHERE GovernorPromotionType = 'GOVERNOR_PROMOTION_REINFORCED_INFRASTRUCTURE';
DELETE
FROM GovernorPromotionPrereqs
WHERE PrereqGovernorPromotion = 'GOVERNOR_PROMOTION_REINFORCED_INFRASTRUCTURE';
INSERT INTO GovernorPromotionPrereqs (GovernorPromotionType, PrereqGovernorPromotion)
VALUES ('GOVERNOR_PROMOTION_RESOURCE_MANAGER_EXPEDITION', 'GOVERNOR_PROMOTION_BUILDER_GUILDMASTER'),
       ('GOVERNOR_PROMOTION_REINFORCED_INFRASTRUCTURE', 'GOVERNOR_PROMOTION_RESOURCE_MANAGER_EXPEDITION'),
       ('GOVERNOR_PROMOTION_WATER_WORKS', 'GOVERNOR_PROMOTION_REINFORCED_INFRASTRUCTURE');

UPDATE ModifierArguments
SET Value = 2
WHERE ModifierId = 'BBG_MAGNUS_DOMESTIC_TRADE_ROUTE_PROD'
  AND Name = 'Amount';

INSERT INTO GovernorPromotionModifiers (GovernorPromotionType, ModifierId)
VALUES ('GOVERNOR_PROMOTION_REINFORCED_INFRASTRUCTURE', 'MODIFIER_GOVERNOR_PROMOTION_REINFORCED_INFRASTRUCTURE_PRODUC');

INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId,
                       SubjectRequirementSetId)
VALUES ('MODIFIER_GOVERNOR_PROMOTION_REINFORCED_INFRASTRUCTURE_PRODUC',
        'MODIFIER_SINGLE_CITY_ADJUST_CITY_YIELD_MODIFIER', 0, 0, 0, NULL, NULL);

INSERT INTO ModifierArguments (ModifierId, Name, Value)
VALUES ('MODIFIER_GOVERNOR_PROMOTION_REINFORCED_INFRASTRUCTURE_PRODUC', 'Amount', '10'),
       ('MODIFIER_GOVERNOR_PROMOTION_REINFORCED_INFRASTRUCTURE_PRODUC', 'YieldType', 'YIELD_PRODUCTION');


-----------------------------------------------------------------------------------------------------------------
-- 马左一变成梁左二
UPDATE GovernorPromotionSets
SET GovernorType='GOVERNOR_THE_RESOURCE_MANAGER'
WHERE GovernorPromotion = 'GOVERNOR_PROMOTION_PARKS_RECREATION';
UPDATE GovernorPromotions
SET Level    = 1,
    'Column' = 0
...
DELETE
FROM GovernorPromotionPrereqs
WHERE PrereqGovernorPromotion = 'GOVERNOR_PROMOTION_PARKS_RECREATION';
INSERT INTO GovernorPromotionPrereqs (GovernorPromotionType, PrereqGovernorPromotion)
VALUES ('GOVERNOR_PROMOTION_PARKS_RECREATION', 'GOVERNOR_PROMOTION_RESOURCE_MANAGER_GROUNDBREAKER'),
       ('GOVERNOR_PROMOTION_RESOURCE_MANAGER_SURPLUS_LOGISTICS', 'GOVERNOR_PROMOTION_PARKS_RECREATION');
...
DELETE
FROM GovernorPromotionPrereqs
WHERE PrereqGovernorPromotion = 'GOVERNOR_PROMOTION_RESOURCE_MANAGER_BLACK_MARKETEER';
UPDATE GovernorPromotions
SET Level    = 2,
    'Column' = 2
WHERE GovernorPromotionType = 'GOVERNOR_PROMOTION_RESOURCE_MANAGER_BLACK_MARKETEER';
...
INSERT INTO GovernorPromotionPrereqs (GovernorPromotionType, PrereqGovernorPromotion)
VALUES ('GOVERNOR_PROMOTION_RESOURCE_MANAGER_BLACK_MARKETEER', 'GOVERNOR_PROMOTION_RESOURCE_MANAGER_INDUSTRIALIST'),
...
WHERE GovernorPromotionType = 'BBG_GOVERNOR_PROMOTION_EDUCATOR_CAMPUS_BUILDING_YIELDS';
INSERT INTO GovernorPromotionModifiers(GovernorPromotionType, ModifierId)
SELECT 'BBG_GOVERNOR_PROMOTION_EDUCATOR_CAMPUS_BUILDING_YIELDS',
       ModifierId
FROM GovernorPromotionModifiers
...
DELETE
FROM GovernorPromotionModifiers
WHERE GovernorPromotionType = 'GOVERNOR_PROMOTION_EDUCATOR_SPACE_INITIATIVE';
INSERT INTO GovernorPromotionModifiers(GovernorPromotionType, ModifierId)
SELECT 'GOVERNOR_PROMOTION_EDUCATOR_SPACE_INITIATIVE',
       ModifierId
FROM GovernorPromotionModifiers
WHERE GovernorPromotionType IN ('GOVERNOR_PROMOTION_WATER_WORKS');


INSERT INTO GovernorPromotionModifiers (GovernorPromotionType, ModifierId)
VALUES ('GOVERNOR_PROMOTION_EDUCATOR_LIBRARIAN', 'MODIFIER_GOVERNOR_PROMOTION_EDUCATOR_LIBRARIAN_3');
INSERT INTO Modifiers (ModifierId, ModifierType)
VALUES ('MODIFIER_GOVERNOR_PROMOTION_EDUCATOR_LIBRARIAN_3', 'MODIFIER_SINGLE_CITY_ADJUST_YIELD_CHANGE');
INSERT INTO ModifierArguments (ModifierId, Name, Value)
VALUES ('MODIFIER_GOVERNOR_PROMOTION_EDUCATOR_LIBRARIAN_3', 'Amount', '3'),
       ('MODIFIER_GOVERNOR_PROMOTION_EDUCATOR_LIBRARIAN_3', 'YieldType', 'YIELD_SCIENCE');
...
SET Level    = 1,
    'Column' = 2
WHERE GovernorPromotionType = 'GOVERNOR_PROMOTION_AMBASSADOR_FOREIGN_INVESTOR';
UPDATE GovernorPromotions
SET Level    = 2,
    'Column' = 2
WHERE GovernorPromotionType = 'GOVERNOR_PROMOTION_AMBASSADOR_PUPPETEER';
UPDATE GovernorPromotions
SET Level    = 3,
    'Column' = 1
WHERE GovernorPromotionType = 'GOVERNOR_PROMOTION_AMBASSADOR_AFFLUENCE';
...
DELETE
FROM GovernorPromotionPrereqs
WHERE PrereqGovernorPromotion = 'GOVERNOR_PROMOTION_AMBASSADOR_FOREIGN_INVESTOR';
DELETE
FROM GovernorPromotionPrereqs
WHERE PrereqGovernorPromotion = 'GOVERNOR_PROMOTION_AMBASSADOR_PUPPETEER';
DELETE
FROM GovernorPromotionPrereqs
WHERE GovernorPromotionType = 'GOVERNOR_PROMOTION_AMBASSADOR_AFFLUENCE';
DELETE
FROM GovernorPromotionPrereqs
WHERE PrereqGovernorPromotion = 'GOVERNOR_PROMOTION_AMBASSADOR_AFFLUENCE';
INSERT INTO GovernorPromotionPrereqs (GovernorPromotionType, PrereqGovernorPromotion)
VALUES ('GOVERNOR_PROMOTION_AMBASSADOR_FOREIGN_INVESTOR', 'GOVERNOR_PROMOTION_AMBASSADOR_MESSENGER'),
       ('GOVERNOR_PROMOTION_AMBASSADOR_PUPPETEER', 'GOVERNOR_PROMOTION_AMBASSADOR_FOREIGN_INVESTOR'),
       ('GOVERNOR_PROMOTION_AMBASSADOR_AFFLUENCE', 'GOVERNOR_PROMOTION_AMBASSADOR_PUPPETEER'),
       ('GOVERNOR_PROMOTION_AMBASSADOR_AFFLUENCE', 'GOVERNOR_PROMOTION_LOCAL_INFORMANTS');

-- GOVERNOR_PROMOTION_AMBASSADOR_FOREIGN_INVESTOR

INSERT INTO GovernorPromotionModifiers (GovernorPromotionType, ModifierId)
SELECT 'GOVERNOR_PROMOTION_AMBASSADOR_FOREIGN_INVESTOR',
       'MODIFIER_GOVERNOR_PROMOTION_AMBASSADOR_FOREIGN_INVESTOR_PRODUCTION_' || BuildingType
FROM Buildings
WHERE PrereqDistrict = 'DISTRICT_GOVERNMENT';

INSERT INTO Modifiers (ModifierId, ModifierType)
SELECT 'MODIFIER_GOVERNOR_PROMOTION_AMBASSADOR_FOREIGN_INVESTOR_PRODUCTION_' || BuildingType,
...
INSERT INTO GovernorPromotionModifiers (GovernorPromotionType, ModifierId)
SELECT 'GOVERNOR_PROMOTION_AMBASSADOR_FOREIGN_INVESTOR',
       'MODIFIER_GOVERNOR_PROMOTION_AMBASSADOR_FOREIGN_INVESTOR_FOOD_' || BuildingType
FROM Buildings
WHERE PrereqDistrict = 'DISTRICT_GOVERNMENT';

INSERT INTO Modifiers (ModifierId, ModifierType)
SELECT 'MODIFIER_GOVERNOR_PROMOTION_AMBASSADOR_FOREIGN_INVESTOR_FOOD_' || BuildingType,
       'MODIFIER_PLAYER_CITIES_ADJUST_BUILDING_YIELD_CHANGE'
FROM Buildings
WHERE PrereqDistrict = 'DISTRICT_GOVERNMENT';
...
INSERT OR IGNORE INTO GovernorPromotionModifiers (GovernorPromotionType, ModifierId)
VALUES ('GOVERNOR_PROMOTION_AMBASSADOR_AFFLUENCE', 'MOD_LIME_TEO_OWL_EMISSARY_HEGEMONY_VASSAL_CS_FAVOR_ATTACH');

INSERT OR IGNORE INTO Modifiers
(ModifierId, ModifierType, SubjectRequirementSetId, SubjectStackLimit, Permanent)
VALUES ('MOD_LIME_TEO_OWL_EMISSARY_HEGEMONY_VASSAL_CS_FAVOR_ATTACH', 'MODIFIER_ALL_CITIES_ATTACH_MODIFIER',
        NULL, NULL, 0), -- Attach a modifier
       ('MOD_LIME_TEO_OWL_EMISSARY_HEGEMONY_VASSAL_FAVOR', 'MODTYPE_LIME_EMISSARY_ALL_PLAYERS_ADJUST_FAVOR_PER_TURN',
        'PLAYER_IS_SUZERAIN', NULL, 0); --PAGODA_ADJUST_FAVOR

INSERT OR IGNORE INTO ModifierArguments
    (ModifierId, Name, Value) --MODIFIER_CITY_INCREASE_DISTRICT_PRODUCTION_RATE
VALUES ('MOD_LIME_TEO_OWL_EMISSARY_HEGEMONY_VASSAL_CS_FAVOR_ATTACH', 'ModifierId',
        'MOD_LIME_TEO_OWL_EMISSARY_HEGEMONY_VASSAL_FAVOR'),
       ('MOD_LIME_TEO_OWL_EMISSARY_HEGEMONY_VASSAL_FAVOR', 'Amount', 2);
...
DELETE
FROM Types
WHERE Type = 'GOVERNOR_PROMOTION_MERCHANT_LAND_ACQUISITION';
DELETE
...
SET Level       = 0,
    'Column'    = 0,
    BaseAbility = 1
WHERE GovernorPromotionType = 'GOVERNOR_PROMOTION_MERCHANT_FORESTRY_MANAGEMENT';
UPDATE GovernorPromotions
SET Level    = 1,
    'Column' = 2
WHERE GovernorPromotionType = 'GOVERNOR_PROMOTION_MERCHANT_TAX_COLLECTOR';
UPDATE GovernorPromotions
SET Level    = 2,
    'Column' = 1
...
DELETE
FROM GovernorPromotionPrereqs
WHERE PrereqGovernorPromotion = 'GOVERNOR_PROMOTION_MERCHANT_FORESTRY_MANAGEMENT';
DELETE
FROM GovernorPromotionPrereqs
WHERE PrereqGovernorPromotion = 'GOVERNOR_PROMOTION_MERCHANT_CONTRACTOR';
INSERT INTO GovernorPromotionPrereqs (GovernorPromotionType, PrereqGovernorPromotion)
VALUES ('GOVERNOR_PROMOTION_MERCHANT_HARBORMASTER', 'GOVERNOR_PROMOTION_MERCHANT_FORESTRY_MANAGEMENT'),
       ('GOVERNOR_PROMOTION_MERCHANT_TAX_COLLECTOR', 'GOVERNOR_PROMOTION_MERCHANT_FORESTRY_MANAGEMENT'),
       ('GOVERNOR_PROMOTION_MERCHANT_CONTRACTOR', 'GOVERNOR_PROMOTION_MERCHANT_TAX_COLLECTOR'),
       ('GOVERNOR_PROMOTION_MERCHANT_CONTRACTOR', 'GOVERNOR_PROMOTION_MERCHANT_HARBORMASTER'),
       ('BBG_GOVERNOR_PROMOTION_MANAGER', 'GOVERNOR_PROMOTION_MERCHANT_CONTRACTOR');
...
-- 中三
INSERT INTO GovernorPromotionModifiers (GovernorPromotionType, ModifierId)
VALUES ('GOVERNOR_PROMOTION_MERCHANT_CURATOR', 'MODIFIER_GOVERNOR_PROMOTION_MERCHANT_CURATOR_HOUSING');

INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId,
                       SubjectRequirementSetId)
VALUES ('MODIFIER_GOVERNOR_PROMOTION_MERCHANT_CURATOR_HOUSING', 'MODIFIER_CITY_DISTRICTS_ADJUST_DISTRICT_HOUSING', 0, 0,
        0, NULL, NULL);

INSERT INTO ModifierArguments (ModifierId, Name, Value)
VALUES ('MODIFIER_GOVERNOR_PROMOTION_MERCHANT_CURATOR_HOUSING', 'Amount', '1');
...
SELECT 'TRAIT_LEADER_MAJOR_CIV',
       'MODIFIER_TRAIT_LEADER_MAJOR_CIV_AI_FREE_' || ResourceType
FROM Resources
WHERE ResourceClassType = 'RESOURCECLASS_LUXURY';

INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId)
SELECT 'MODIFIER_TRAIT_LEADER_MAJOR_CIV_AI_FREE_' || ResourceType,
