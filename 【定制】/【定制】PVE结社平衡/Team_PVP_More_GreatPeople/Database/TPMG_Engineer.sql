...
DELETE FROM Types WHERE Type IN (
        'GREAT_PERSON_INDIVIDUAL_NW_ENGINEER_CLASSICAL_1',
        'GREAT_PERSON_INDIVIDUAL_NW_ENGINEER_MEDIEVAL_1',
        'GREAT_PERSON_INDIVIDUAL_NW_ENGINEER_MEDIEVAL_2',
        'GREAT_PERSON_INDIVIDUAL_NW_ENGINEER_RENAISSANCE_2',
        'GREAT_PERSON_INDIVIDUAL_NW_ENGINEER_INDUSTRIAL_2',
        'GREAT_PERSON_INDIVIDUAL_NW_ENGINEER_MODERN_1',
        'GREAT_PERSON_INDIVIDUAL_NW_ENGINEER_MODERN_2',
        'GREAT_PERSON_INDIVIDUAL_JAMES_OF_ST_GEORGE',
        'GREAT_PERSON_INDIVIDUAL_ROBERT_GODDARD');
