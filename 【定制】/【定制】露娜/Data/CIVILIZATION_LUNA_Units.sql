--	FILE: CIVILIZATION_LUNA_Unit.sql
--  VERSION: 1
--  Author: Nwflower
--  Spicial Thanks: Uni
--	Copyright (c) 2025.
...
VALUES ('UNIT_LUNAR_BOAT', 'KIND_UNIT');

INSERT INTO TypeTags(Type, Tag)
SELECT 'UNIT_LUNAR_BOAT', Tag
FROM TypeTags
WHERE Type = 'UNIT_FRIGATE';


INSERT INTO UnitAiInfos(UnitType, AiType)
SELECT 'UNIT_LUNAR_BOAT', AiType
FROM UnitAiInfos
WHERE UnitType = 'UNIT_FRIGATE';

-- 单位是否替代原型单位
INSERT INTO UnitReplaces (civuniqueunittype, replacesunittype)
VALUES ('UNIT_LUNAR_BOAT', 'UNIT_FRIGATE');
...
INSERT INTO Units_XP2(UnitType, ResourceMaintenanceAmount, ResourceCost, ResourceMaintenanceType, TourismBomb,
                      ...
                      CanSacrificeUnits)
SELECT 'UNIT_LUNAR_BOAT',
       ResourceMaintenanceAmount, -- 每回合消耗的战略资源数量
       ResourceCost / 2, -- 建造单位需要的战略资源数量
...
SELECT 'UNIT_LUNAR_BOAT',                 -- 类型
       'LOC_UNIT_LUNAR_BOAT_NAME',        -- 名称
       BaseSightRange,                            --视野
       6,                                 -- 移动力
       50,                                    -- 近战力
       55,                              -- 远程力
       ...
       'LOC_UNIT_LUNAR_BOAT_DESCRIPTION', -- 描述文本
       Flavor,
       CanCapture,                                -- 可以俘虏平民单位
       CanRetreatWhenCaptured,                    -- 被俘虏时传送回最近城市
       'TRAIT_UNIT_LUNAR_BOAT',           -- 绑定特性
...
VALUES ( 'ABILITY_UNIT_LUNAR_BOAT','KIND_ABILITY');
INSERT OR IGNORE INTO Tags(Tag, Vocabulary)
VALUES ('CLASS_UNIT_LUNAR_BOAT','ABILITY_CLASS');
INSERT OR IGNORE INTO TypeTags(Type,Tag)
VALUES ('ABILITY_UNIT_LUNAR_BOAT','CLASS_UNIT_LUNAR_BOAT'),
       ('UNIT_LUNAR_BOAT','CLASS_UNIT_LUNAR_BOAT');
INSERT OR IGNORE INTO UnitAbilities(UnitAbilityType,Name,Description)
VALUES ( 'ABILITY_UNIT_LUNAR_BOAT' ,'LOC_ABILITY_UNIT_LUNAR_BOAT_NAME','LOC_ABILITY_UNIT_LUNAR_BOAT_NAME');
INSERT OR IGNORE INTO UnitAbilityModifiers(UnitAbilityType,ModifierId)
VALUES( 'ABILITY_UNIT_LUNAR_BOAT', 'ESCORT_MOBILITY_SHARED_MOVEMENT');