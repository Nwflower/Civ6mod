...
VALUES ('UNIT_CAR_CALAVEY', 'KIND_UNIT');
INSERT INTO Tags(Tag, Vocabulary)
VALUES ('CLASS_CAR_CALAVEY', 'ABILITY_CLASS');
INSERT INTO TypeTags(Type, Tag)
VALUES ('UNIT_CAR_CALAVEY', 'CLASS_CAR_CALAVEY');

INSERT INTO UnitAiInfos(UnitType, AiType)
SELECT 'UNIT_CAR_CALAVEY', AiType
FROM UnitAiInfos
WHERE UnitType = 'UNIT_BATTERING_RAM';

-- 单位是否替代原型单位
INSERT INTO UnitReplaces (civuniqueunittype, replacesunittype)
VALUES ('UNIT_CAR_CALAVEY', 'UNIT_BATTERING_RAM');
...
SELECT 'UNIT_CAR_CALAVEY',                 -- 类型
       'LOC_UNIT_CAR_CALAVEY_NAME',        -- 名称
       BaseSightRange,                            --视野
       3,                                 -- 移动力
       Combat,                                    -- 近战力
       RangedCombat,                              -- 远程力
       ...
       'LOC_UNIT_CAR_CALAVEY_DESCRIPTION', -- 描述文本
       Flavor,
       CanCapture,                                -- 可以俘虏平民单位
       CanRetreatWhenCaptured,                    -- 被俘虏时传送回最近城市
       'TRAIT_UNIT_CAR_CALAVEY',           -- 绑定特性
...
VALUES ( 'ABILITY_NW_CALAVEY_ENABLE_WALL','KIND_ABILITY');
INSERT OR IGNORE INTO TypeTags(Type,Tag)
VALUES ('ABILITY_NW_CALAVEY_ENABLE_WALL','CLASS_CAR_CALAVEY');
INSERT OR IGNORE INTO UnitAbilities(UnitAbilityType,Inactive,Name,Description)
VALUES ( 'ABILITY_NW_CALAVEY_ENABLE_WALL', 0 ,'LOC_ABILITY_NW_CALAVEY_ENABLE_WALL_NAME','LOC_ABILITY_NW_CALAVEY_ENABLE_WALL_NAME');

INSERT INTO UnitAbilityModifiers (UnitAbilityType, ModifierId) VALUES
('ABILITY_NW_CALAVEY_ENABLE_WALL', 'MODIFIER_ABILITY_NW_CALAVEY_ENABLE_WALL');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
('MODIFIER_ABILITY_NW_CALAVEY_ENABLE_WALL', 'MODIFIER_PLAYER_UNITS_ADJUST_ENABLE_WALL_ATTACK_WHOLE_GAME_PROMOTION_CLASS', 0, 0, 0, NULL, 'REQS_MODIFIER_ABILITY_NW_CALAVEY_ENABLE_WALL');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
('MODIFIER_ABILITY_NW_CALAVEY_ENABLE_WALL', 'PromotionClass', 'PROMOTION_CLASS_LIGHT_CAVALRY');

INSERT INTO UnitAbilityModifiers (UnitAbilityType, ModifierId) VALUES
('ABILITY_NW_CALAVEY_ENABLE_WALL', 'MODIFIER_ABILITY_NW_CALAVEY_ENABLE_WALL2');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
('MODIFIER_ABILITY_NW_CALAVEY_ENABLE_WALL2', 'MODIFIER_PLAYER_UNITS_ADJUST_ENABLE_WALL_ATTACK_WHOLE_GAME_PROMOTION_CLASS', 0, 0, 0, NULL, 'REQS_MODIFIER_ABILITY_NW_CALAVEY_ENABLE_WALL');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
('MODIFIER_ABILITY_NW_CALAVEY_ENABLE_WALL2', 'PromotionClass', 'PROMOTION_CLASS_HEAVY_CAVALRY');

-- RequirementSets
INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES
('REQS_MODIFIER_ABILITY_NW_CALAVEY_ENABLE_WALL', 'REQUIREMENTSET_TEST_ALL');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
('REQS_MODIFIER_ABILITY_NW_CALAVEY_ENABLE_WALL', 'REQ_MODIFIER_ABILITY_NW_CALAVEY_ENABLE_WALL');
-- Requirements
INSERT INTO Requirements (RequirementId, RequirementType) VALUES
('REQ_MODIFIER_ABILITY_NW_CALAVEY_ENABLE_WALL', 'REQUIREMENT_PLOT_ADJACENT_TO_OWNER');
INSERT INTO RequirementArguments (RequirementId, Name, Value) VALUES
('REQ_MODIFIER_ABILITY_NW_CALAVEY_ENABLE_WALL', 'MaxDistance', '1'),
('REQ_MODIFIER_ABILITY_NW_CALAVEY_ENABLE_WALL', 'MinDistance', '0');
