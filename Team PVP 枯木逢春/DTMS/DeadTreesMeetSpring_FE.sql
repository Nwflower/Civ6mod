...
-- ('NW_DTMS_NATUREWONDER_REBALANCE','LOC_NW_DTMS_NATUREWONDER_REBALANCE_NAME','LOC_NW_DTMS_NATUREWONDER_REBALANCE_DESCRIPTION','bool',1,'Game','NW_DTMS_NATUREWONDER_REBALANCE','AdvancedOptions',1640);
