...
INSERT INTO ModifierArguments (ModifierId, Name, Value)
VALUES ('MODIFIER_TRAIT_LEADER_EXALTED_GODDESS_HALF_HOLYSITE', 'Amount', 75),
...
SET ModifierType           = 'MODIFIER_PLAYER_CITIES_ADJUST_UNITS_PURCHASE_COST',
    SubjectRequirementSetId='NW_CITY_HAS_DISTRICT_HOLY_SITE'
WHERE ModifierId = 'BUY_RONGKECHUAN_ZHEKOU';

UPDATE ModifierArguments
SET Name = 'UnitDomain' AND Value = 'DOMAIN_SEA'
WHERE ModifierId = 'BUY_RONGKECHUAN_ZHEKOU'
  AND Name = 'UnitType';
UPDATE ModifierArguments
SET Value = 10
