...
SET Value='0'
WHERE ModifierId IN
      ('TRAIT_ANTIQUES_AND_PARKS_CULTURE_FORESTS_OR_WONDERS', 'TRAIT_ANTIQUES_AND_PARKS_CULTURE_FORESTS_OR_WONDERS2',
...
VALUES ('NW_PLOT_IS_BREATHTAKING_AND_UNIMPROVED', 'REQUIREMENT_NW_PLOT_IS_BREATHTAKING'),
       ...
       ('NW_PLOT_IS_BREATHTAKING_AND_UNIMPROVED', 'REQUIREMENT_NW_PLOT_ADJACENT_DISTRICT_PRESERVE');
-- Requirements
INSERT INTO Requirements (RequirementId, RequirementType, Inverse)
VALUES ('REQUIREMENT_NW_PLOT_IS_UNIMPROVED', 'REQUIREMENT_PLOT_HAS_ANY_IMPROVEMENT', 1),
       ('REQUIREMENT_NW_PLOT_ADJACENT_DISTRICT_PRESERVE', 'REQUIREMENT_PLOT_ADJACENT_DISTRICT_TYPE_MATCHES', 0);

INSERT INTO RequirementArguments (RequirementId, Name, Value)
VALUES ('REQUIREMENT_NW_PLOT_ADJACENT_DISTRICT_PRESERVE', 'DistrictType', 'DISTRICT_PRESERVE'),
       ('REQUIREMENT_NW_PLOT_ADJACENT_DISTRICT_PRESERVE', 'MaxRange', '1'),
       ('REQUIREMENT_NW_PLOT_ADJACENT_DISTRICT_PRESERVE', 'MinRange', '1');
-- 保护区赠送自然学家
INSERT INTO TraitModifiers (TraitType, ModifierId)
...
WITH RECURSIVE
    ...
    total_corrections AS (SELECT k,
                                 (k + 1) / 2 - ( k +2 ) / 3 AS total_correction
                          FROM seq),
...
-- DELETE FROM TraitModifiers WHERE TraitType = 'TRAIT_LEADER_ELEANOR_LOYALTY' AND ModifierId = 'TRAIT_EXTRA_PALACE_SLOTS_AILINUO';
...
VALUES ('MODIFIER_TRAIT_LEADER_ELEANOR_FRANCE_LOYALTY_TEAM_PVP_BOOST',
        'MODIFIER_NW_ALN_PLAYER_GRANT_RANDOM_CIVIC_BOOST_BY_ERA', 0, 0, 0, NULL, 'NW_UNIT_IS_ANY_GP');
INSERT INTO ModifierArguments (ModifierId, Name, Value)
VALUES ('MODIFIER_TRAIT_LEADER_ELEANOR_FRANCE_LOYALTY_TEAM_PVP_BOOST', 'Amount', '2');

-- Custom ModifierType
INSERT INTO Types (Type, Kind)
VALUES ('MODIFIER_NW_ALN_PLAYER_GRANT_RANDOM_CIVIC_BOOST_BY_ERA', 'KIND_MODIFIER');
INSERT INTO DynamicModifiers (ModifierType, CollectionType, EffectType)
VALUES ('MODIFIER_NW_ALN_PLAYER_GRANT_RANDOM_CIVIC_BOOST_BY_ERA', 'COLLECTION_PLAYER_UNITS',
...
WHERE YieldChangeId = 'TRAIT_LEADER_MAGNIFICENCES_THEATER'
