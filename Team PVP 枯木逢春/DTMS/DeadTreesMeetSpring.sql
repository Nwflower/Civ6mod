...
FROM TraitModifiers
WHERE TraitType = 'TRAIT_LEADER_ELEANOR_LOYALTY'
  AND ModifierId = 'TRAIT_EXTRA_PALACE_SLOTS_AILINUO_DISTRICT_THEATER2';
...
CREATE TRIGGER Nw_GoldFrance_District_Adjacencies
    AFTER INSERT
    ON LeaderTraits
    WHEN NEW.LeaderType IS NOT 'LEADER_DEFAULT'
BEGIN
    INSERT OR
        IGNORE
...
('TRAIT_CIVILIZATION_ADJACENT_DISTRICTS', 'NW_TRAIT_CIVILIZATION_ADJACENT_DISTRICTS_GRANT_ABILITY_NW_JP_UNIT_SETTLE');
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES
('NW_TRAIT_CIVILIZATION_ADJACENT_DISTRICTS_GRANT_ABILITY_NW_JP_UNIT_SETTLE', 'MODIFIER_PLAYER_UNITS_GRANT_ABILITY' ,'REQS_NW_GAME_IS_1TURN');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
('NW_TRAIT_CIVILIZATION_ADJACENT_DISTRICTS_GRANT_ABILITY_NW_JP_UNIT_SETTLE', 'AbilityType', 'ABILITY_NW_JP_UNIT_SETTLE');

INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES
('REQS_NW_GAME_IS_1TURN', 'REQUIREMENTSET_TEST_ALL');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
('REQS_NW_GAME_IS_1TURN', 'REQ_NW_GAME_IS_1TURN');
INSERT INTO Requirements (RequirementId, RequirementType, Inverse) VALUES
('REQ_NW_GAME_IS_1TURN', 'REQUIREMENT_GAME_TURN_ATLEAST', 1);
INSERT INTO RequirementArguments (RequirementId, Name, Value) VALUES
('REQ_NW_GAME_IS_1TURN', 'MinGameTurn', 1);
...
INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES
('TRAIT_LEADER_DIVINE_WIND', 'MODIFIER_TRAIT_LEADER_DIVINE_WIND_HARBOR_PRO_ATTACH');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
('MODIFIER_TRAIT_LEADER_DIVINE_WIND_HARBOR_PRO_ATTACH', 'MODIFIER_PLAYER_CAPITAL_CITY_ATTACH_MODIFIER', 0, 0, 0, NULL, 'PLOT_IS_COASTAL_LAND_REQUIREMENTS');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
('MODIFIER_TRAIT_LEADER_DIVINE_WIND_HARBOR_PRO_ATTACH', 'ModifierId', 'MODIFIER_TRAIT_LEADER_DIVINE_WIND_HARBOR_PRO');

INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES
('TRAIT_LEADER_DIVINE_WIND', 'MODIFIER_TRAIT_LEADER_DIVINE_WIND_DISTRICT_COMMERCIAL_HUB_PRO_ATTACH');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
('MODIFIER_TRAIT_LEADER_DIVINE_WIND_DISTRICT_COMMERCIAL_HUB_PRO_ATTACH', 'MODIFIER_PLAYER_CAPITAL_CITY_ATTACH_MODIFIER', 0, 0, 0, NULL, 'REQS_NW_PLOT_NOTS_COASTAL_LAND_REQUIREMENTS');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
('MODIFIER_TRAIT_LEADER_DIVINE_WIND_DISTRICT_COMMERCIAL_HUB_PRO_ATTACH', 'ModifierId', 'MODIFIER_TRAIT_LEADER_DIVINE_WIND_DISTRICT_COMMERCIAL_HUB_PRO');

INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES
('TRAIT_LEADER_DIVINE_WIND', 'MODIFIER_TRAIT_LEADER_DIVINE_WIND_DISTRICT_HOLY_SITE_PRO_ATTACH');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
('MODIFIER_TRAIT_LEADER_DIVINE_WIND_DISTRICT_HOLY_SITE_PRO_ATTACH', 'MODIFIER_PLAYER_CAPITAL_CITY_ATTACH_MODIFIER', 0, 0, 0, NULL, 'REQS_NW_PLOT_NOTS_COASTAL_LAND_REQUIREMENTS');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
('MODIFIER_TRAIT_LEADER_DIVINE_WIND_DISTRICT_HOLY_SITE_PRO_ATTACH', 'ModifierId', 'MODIFIER_TRAIT_LEADER_DIVINE_WIND_DISTRICT_HOLY_SITE_PRO');
...
-- RequirementSets
INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES
('REQS_NW_PLOT_NOTS_COASTAL_LAND_REQUIREMENTS', 'REQUIREMENTSET_TEST_ALL');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
('REQS_NW_PLOT_NOTS_COASTAL_LAND_REQUIREMENTS', 'REQ_NW_PLOT_NOTS_COASTAL_LAND_REQUIREMENTS');
-- Requirements
INSERT INTO Requirements (RequirementId, RequirementType, Inverse) VALUES
('REQ_NW_PLOT_NOTS_COASTAL_LAND_REQUIREMENTS', 'REQUIREMENT_PLOT_IS_COASTAL_LAND', 1);

INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
('MODIFIER_TRAIT_LEADER_DIVINE_WIND_HARBOR_PRO', 'MODIFIER_PLAYER_CITIES_ADJUST_DISTRICT_PRODUCTION', 0, 0, 0, NULL, NULL);
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
('MODIFIER_TRAIT_LEADER_DIVINE_WIND_HARBOR_PRO', 'Amount', 80),
('MODIFIER_TRAIT_LEADER_DIVINE_WIND_HARBOR_PRO', 'DistrictType', 'DISTRICT_HARBOR');

INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
('MODIFIER_TRAIT_LEADER_DIVINE_WIND_DISTRICT_COMMERCIAL_HUB_PRO', 'MODIFIER_PLAYER_CITIES_ADJUST_DISTRICT_PRODUCTION', 0, 0, 0, NULL, NULL);
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
('MODIFIER_TRAIT_LEADER_DIVINE_WIND_DISTRICT_COMMERCIAL_HUB_PRO', 'Amount', 55),
('MODIFIER_TRAIT_LEADER_DIVINE_WIND_DISTRICT_COMMERCIAL_HUB_PRO', 'DistrictType', 'DISTRICT_COMMERCIAL_HUB');

INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
('MODIFIER_TRAIT_LEADER_DIVINE_WIND_DISTRICT_HOLY_SITE_PRO', 'MODIFIER_PLAYER_CITIES_ADJUST_DISTRICT_PRODUCTION', 0, 0, 0, NULL, NULL);
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
('MODIFIER_TRAIT_LEADER_DIVINE_WIND_DISTRICT_HOLY_SITE_PRO', 'Amount', 55),
