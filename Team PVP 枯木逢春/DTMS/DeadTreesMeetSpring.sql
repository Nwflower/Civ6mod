...
UPDATE ModifierArguments
SET Value='0'
WHERE ModifierId = 'TRAIT_ANTIQUES_AND_PARKS_CULTURE_FORESTS_OR_WONDERS'
  and Name = 'Amount';
UPDATE ModifierArguments
SET Value='0'
WHERE ModifierId = 'TRAIT_ANTIQUES_AND_PARKS_SCIENCE_NATIONAL_WONDERS_OR_MOUNTAINS'
  and Name = 'Amount';
...
('MODIFIER_NW_PLAYER_UNITS_ADJUST_PROPERTY', 'KIND_MODIFIER');
INSERT INTO DynamicModifiers (ModifierType, CollectionType, EffectType) VALUES
('MODIFIER_NW_PLAYER_UNITS_ADJUST_PROPERTY', 'COLLECTION_PLAYER_UNITS', 'EFFECT_ADJUST_UNIT_PROPERTY');


INSERT INTO Modifiers (ModifierId, ModifierType) VALUES
('MODIFIER_TRAIT_LEADER_ROOSEVELT_COROLLARY_ADD_JUST_PROPERTY', 'MODIFIER_NW_PLAYER_UNITS_ADJUST_PROPERTY');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
('MODIFIER_TRAIT_LEADER_ROOSEVELT_COROLLARY_ADD_JUST_PROPERTY', 'Key', 'ROOSEVELT_COMBAT_BONUS_HOME_CONTINENT'),
...
('DISTRICT_GOVERNMENT','MODIFIER_TRAIT_LEADER_ROOSEVELT_COROLLARY_ADD_JUST_PROPERTY');
INSERT INTO BuildingModifiers(BuildingType, ModifierId) SELECT
BuildingType,'MODIFIER_TRAIT_LEADER_ROOSEVELT_COROLLARY_ADD_JUST_PROPERTY'
FROM Buildings
WHERE PrereqDistrict = 'DISTRICT_GOVERNMENT';

INSERT INTO Modifiers (ModifierId, ModifierType) VALUES
('MODIFIER_TRAIT_LEADER_ROOSEVELT_COROLLARY_ADD_JUST_PROPERTY2', 'MODIFIER_NW_PLAYER_UNITS_ADJUST_PROPERTY');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
('MODIFIER_TRAIT_LEADER_ROOSEVELT_COROLLARY_ADD_JUST_PROPERTY2', 'Key', 'ROOSEVELT_COMBAT_BONUS_NOT_HOME_CONTINENT'),
('MODIFIER_TRAIT_LEADER_ROOSEVELT_COROLLARY_ADD_JUST_PROPERTY2', 'Amount', '1');


INSERT INTO DistrictModifiers(DistrictType, ModifierId) VALUES
('DISTRICT_DIPLOMATIC_QUARTER','MODIFIER_TRAIT_LEADER_ROOSEVELT_COROLLARY_ADD_JUST_PROPERTY2');
INSERT INTO BuildingModifiers(BuildingType, ModifierId) SELECT
BuildingType,'MODIFIER_TRAIT_LEADER_ROOSEVELT_COROLLARY_ADD_JUST_PROPERTY2'
FROM Buildings
...
DELETE FROM TraitModifiers WHERE TraitType = 'TRAIT_CIVILIZATION_SCOTTISH_ENLIGHTENMENT' AND
...
UPDATE ModifierArguments SET Value = 5 WHERE ModifierId = 'TRAIT_SCIENCE_HAPPY' AND Name = 'Amount';
UPDATE ModifierArguments SET Value = 5 WHERE ModifierId = 'TRAIT_PRODUCTION_HAPPY' AND Name = 'Amount';
UPDATE ModifierArguments SET Value = 10 WHERE ModifierId = 'TRAIT_SCIENCE_ECSTATIC' AND Name = 'Amount';
UPDATE ModifierArguments SET Value = 10 WHERE ModifierId = 'TRAIT_PRODUCTION_ECSTATIC' AND Name = 'Amount';

-- =============================================================
-- 埃莉诺
INSERT INTO Types (Type, Kind) VALUES
('MODIFIER_NW_CAPITAL_GRANT_GREAT_PERSON_CLASS_IN_CITY', 'KIND_MODIFIER');
INSERT INTO DynamicModifiers (ModifierType, CollectionType, EffectType) VALUES
('MODIFIER_NW_CAPITAL_GRANT_GREAT_PERSON_CLASS_IN_CITY', 'COLLECTION_PLAYER_CAPITAL_CITY', 'EFFECT_GRANT_GREAT_PERSON_CLASS_IN_CITY');

UPDATE Modifiers SET ModifierType = 'MODIFIER_NW_CAPITAL_GRANT_GREAT_PERSON_CLASS_IN_CITY' WHERE ModifierId = 'TRAIT_BONUS_GREAT_PROPHET_POINT_c';
UPDATE Modifiers SET ModifierType = 'MODIFIER_NW_CAPITAL_GRANT_GREAT_PERSON_CLASS_IN_CITY' WHERE ModifierId = 'TRAIT_BONUS_GREAT_PROPHET_POINT_D';
UPDATE ModifierArguments SET Value = 3 WHERE ModifierId = 'ELEANOR_DOUBLE_SCULPTURE_S1' AND Name = 'YieldChange';