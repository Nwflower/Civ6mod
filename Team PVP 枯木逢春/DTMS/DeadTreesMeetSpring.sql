...
SELECT TraitType
FROM Traits WHERE Description IS NOT NULL ;
...
WHERE TraitType = 'TRAIT_LEADER_ANTIQUES_AND_PARKS'
  AND ModifierId IN ('WENMEI_YULINMEILI_TEAMPVP', 'TRAIT_WILD_CARD_FAVOR', 'TRAIT_ANTIQUES_AND_PARKS_CULTURE_FORESTS_OR_WONDERS', 'TRAIT_ANTIQUES_AND_PARKS_CULTURE_FORESTS_OR_WONDERS2',
...
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId,
                       SubjectRequirementSetId)
VALUES ('MODIFIER_ABILITY_NW_AZTK_ADD_COMBAT', 'MODIFIER_UNIT_ADJUST_COMBAT_STRENGTH', 0, 0, 0, NULL, 'REQS_MODIFIER_ABILITY_NW_AZTK_ADD_COMBAT');
INSERT INTO ModifierArguments (ModifierId, Name, Value)
VALUES ('MODIFIER_ABILITY_NW_AZTK_ADD_COMBAT', 'Amount', 1);
INSERT INTO ModifierStrings (ModifierId, Context, Text) VALUES
('MODIFIER_ABILITY_NW_AZTK_ADD_COMBAT', 'Preview', 'LOC_MODIFIER_ABILITY_NW_AZTK_ADD_COMBAT');

-- RequirementSets
INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES
('REQS_MODIFIER_ABILITY_NW_AZTK_ADD_COMBAT', 'REQUIREMENTSET_TEST_ALL');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
('REQS_MODIFIER_ABILITY_NW_AZTK_ADD_COMBAT', 'REQ_MODIFIER_ABILITY_NW_AZTK_ADD_COMBAT1'),
('REQS_MODIFIER_ABILITY_NW_AZTK_ADD_COMBAT', 'REQ_MODIFIER_ABILITY_NW_AZTK_ADD_COMBAT2');
-- Requirements
INSERT INTO Requirements (RequirementId, RequirementType, Inverse) VALUES
('REQ_MODIFIER_ABILITY_NW_AZTK_ADD_COMBAT1', 'REQUIREMENT_PLOT_IS_APPEAL_BETWEEN', 0),
('REQ_MODIFIER_ABILITY_NW_AZTK_ADD_COMBAT2', 'REQUIREMENT_PLAYER_IS_ATTACKING', 1);
INSERT INTO RequirementArguments (RequirementId, Name, Value) VALUES
('REQ_MODIFIER_ABILITY_NW_AZTK_ADD_COMBAT1', 'MinimumAppeal', '2');



INSERT INTO UnitAbilityModifiers (UnitAbilityType, ModifierId) VALUES
('ABILITY_NW_AZTK', 'MODIFIER_ABILITY_NW_AZTK_ADD_COMBAT_ATTACK');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
('MODIFIER_ABILITY_NW_AZTK_ADD_COMBAT_ATTACK', 'MODIFIER_UNIT_ADJUST_COMBAT_STRENGTH', 0, 0, 0, NULL, 'REQS_MODIFIER_ABILITY_NW_AZTK_ADD_COMBAT_ATTACK');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
('MODIFIER_ABILITY_NW_AZTK_ADD_COMBAT_ATTACK', 'Amount', '1');
INSERT INTO ModifierStrings (ModifierId, Context, Text) VALUES
('MODIFIER_ABILITY_NW_AZTK_ADD_COMBAT_ATTACK', 'Preview', 'LOC_MODIFIER_ABILITY_NW_AZTK_ADD_COMBAT');

-- RequirementSets
INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES
('REQS_MODIFIER_ABILITY_NW_AZTK_ADD_COMBAT_ATTACK', 'REQUIREMENTSET_TEST_ALL');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
('REQS_MODIFIER_ABILITY_NW_AZTK_ADD_COMBAT_ATTACK', 'REQ_MODIFIER_ABILITY_NW_AZTK_ADD_COMBAT_ATTACK1'),
('REQS_MODIFIER_ABILITY_NW_AZTK_ADD_COMBAT_ATTACK', 'REQ_MODIFIER_ABILITY_NW_AZTK_ADD_COMBAT_ATTACK2');
-- Requirements
INSERT INTO Requirements (RequirementId, RequirementType,Inverse) VALUES
('REQ_MODIFIER_ABILITY_NW_AZTK_ADD_COMBAT_ATTACK1', 'REQUIREMENT_PLOT_IS_APPEAL_BETWEEN',1),
('REQ_MODIFIER_ABILITY_NW_AZTK_ADD_COMBAT_ATTACK2', 'REQUIREMENT_PLAYER_IS_ATTACKING',0);
INSERT INTO RequirementArguments (RequirementId, Name, Value) VALUES
('REQ_MODIFIER_ABILITY_NW_AZTK_ADD_COMBAT_ATTACK1', 'MinimumAppeal', '2');

INSERT INTO BuildingModifiers(BuildingType, ModifierId) VALUES
('BUILDING_TLACHTLI','GUILDMASTER_ADDITIONAL_BUILDER_CHARGES');
...
INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES
('TRAIT_LEADER_PACHACUTI_QHAPAQ_NAN', 'MODIFIER_TRAIT_LEADER_PACHACUTI_QHAPAQ_NAN_ESCORT_MOBILITY');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
('MODIFIER_TRAIT_LEADER_PACHACUTI_QHAPAQ_NAN_ESCORT_MOBILITY', 'MODIFIER_NW_DMTS_PLAYER_UNITS_ADJUST_ESCORT_MOBILITY', 0, 0, 0, NULL, 'REQS_UNIT_PROMOTION_IS_PROMOTION_CLASS_RECON');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
('MODIFIER_TRAIT_LEADER_PACHACUTI_QHAPAQ_NAN_ESCORT_MOBILITY', 'EscortMobility', '1');

-- Custom ModifierType
INSERT INTO Types (Type, Kind) VALUES
('MODIFIER_NW_DMTS_PLAYER_UNITS_ADJUST_ESCORT_MOBILITY', 'KIND_MODIFIER');
INSERT INTO DynamicModifiers (ModifierType, CollectionType, EffectType) VALUES
('MODIFIER_NW_DMTS_PLAYER_UNITS_ADJUST_ESCORT_MOBILITY', 'COLLECTION_PLAYER_UNITS', 'EFFECT_ADJUST_UNIT_ESCORT_MOBILITY');

-- RequirementSets
INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES
('REQS_UNIT_PROMOTION_IS_PROMOTION_CLASS_RECON', 'REQUIREMENTSET_TEST_ALL');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
('REQS_UNIT_PROMOTION_IS_PROMOTION_CLASS_RECON', 'REQ_UNIT_PROMOTION_IS_PROMOTION_CLASS_RECON');
-- Requirements
INSERT INTO Requirements (RequirementId, RequirementType) VALUES
('REQ_UNIT_PROMOTION_IS_PROMOTION_CLASS_RECON', 'REQUIREMENT_UNIT_PROMOTION_CLASS_MATCHES');
INSERT INTO RequirementArguments (RequirementId, Name, Value) VALUES
('REQ_UNIT_PROMOTION_IS_PROMOTION_CLASS_RECON', 'UnitPromotionClass', 'PROMOTION_CLASS_RECON');


INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES
('TRAIT_LEADER_PACHACUTI_QHAPAQ_NAN', 'MODIFIER_TRAIT_LEADER_PACHACUTI_QHAPAQ_NAN_GRANT_UNIT_IN_CAPITAL');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
('MODIFIER_TRAIT_LEADER_PACHACUTI_QHAPAQ_NAN_GRANT_UNIT_IN_CAPITAL', 'MODIFIER_PLAYER_GRANT_UNIT_IN_CAPITAL', 1, 1, 0, 'NW_PLAYER_HAS_CIVIC_FOREIGN_TRADE', NULL);
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
('MODIFIER_TRAIT_LEADER_PACHACUTI_QHAPAQ_NAN_GRANT_UNIT_IN_CAPITAL', 'AllowUniqueOverride', '1'),
...
-- KOREA	朝鲜
INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES
('TRAIT_LEADER_HWARANG', 'MODIFIER_TRAIT_LEADER_HWARANG_GOLD');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
('MODIFIER_TRAIT_LEADER_HWARANG_GOLD', 'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_MODIFIER_PER_GOVERNOR_TITLE', 0, 0, 0, NULL, NULL);
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
('MODIFIER_TRAIT_LEADER_HWARANG_GOLD', 'Amount', '3'),
('MODIFIER_TRAIT_LEADER_HWARANG_GOLD', 'YieldType', 'YIELD_GOLD');


INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES
('TRAIT_LEADER_HWARANG', 'MODIFIER_TRAIT_LEADER_HWARANG_FOOD');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
('MODIFIER_TRAIT_LEADER_HWARANG_FOOD', 'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_MODIFIER_PER_GOVERNOR_TITLE', 0, 0, 0, NULL, NULL);
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
('MODIFIER_TRAIT_LEADER_HWARANG_FOOD', 'Amount', '1'),
('MODIFIER_TRAIT_LEADER_HWARANG_FOOD', 'YieldType', 'YIELD_FOOD');


INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES
('TRAIT_LEADER_HWARANG', 'MODIFIER_TRAIT_LEADER_HWARANG_PRODUCTION');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
('MODIFIER_TRAIT_LEADER_HWARANG_PRODUCTION', 'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_MODIFIER_PER_GOVERNOR_TITLE', 0, 0, 0, NULL, NULL);
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
('MODIFIER_TRAIT_LEADER_HWARANG_PRODUCTION', 'Amount', '1'),
('MODIFIER_TRAIT_LEADER_HWARANG_PRODUCTION', 'YieldType', 'YIELD_PRODUCTION');


INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES
('TRAIT_LEADER_HWARANG', 'MODIFIER_TRAIT_LEADER_HWARANG_FAITH');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
('MODIFIER_TRAIT_LEADER_HWARANG_FAITH', 'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_MODIFIER_PER_GOVERNOR_TITLE', 0, 0, 0, NULL, NULL);
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
('MODIFIER_TRAIT_LEADER_HWARANG_FAITH', 'Amount', '2'),
('MODIFIER_TRAIT_LEADER_HWARANG_FAITH', 'YieldType', 'YIELD_FAITH');

-- =============================================================
-- MACEDON	马其顿
-- TRAIT_LEADER_TO_WORLDS_END
DELETE FROM TraitModifiers WHERE TraitType = 'TRAIT_LEADER_TO_WORLDS_END' AND ModifierId = 'MAQIDUN_DAJUN_DIANSHU_1';
DELETE FROM TraitModifiers WHERE TraitType = 'TRAIT_LEADER_TO_WORLDS_END' AND ModifierId = 'MAQIDUN_DAJUN_DIANSHU_2';

INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES
('TRAIT_LEADER_TO_WORLDS_END', 'MODIFIER_TRAIT_LEADER_TO_WORLDS_END_ALLIANCE_POINTS');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
('MODIFIER_TRAIT_LEADER_TO_WORLDS_END_ALLIANCE_POINTS', 'MODIFIER_PLAYER_ADJUST_ALLIANCE_POINTS', 0, 0, 0, NULL, NULL);
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
('MODIFIER_TRAIT_LEADER_TO_WORLDS_END_ALLIANCE_POINTS', 'Amount', '2');
...
INSERT INTO Types(Type, Kind) SELECT
'GREAT_PERSON_INDIVIDUAL_ALEXANDER_'||number,'KIND_GREAT_PERSON_INDIVIDUAL'
FROM TEMP_ALEXANDER_NUMBERS;
INSERT INTO GreatPersonIndividuals (GreatPersonIndividualType, Name, GreatPersonClassType, EraType, Gender, ActionCharges,AreaHighlightRadius,ActionRequiresCityStateTerritory,ActionRequiresOwnedTile,ActionNameTextOverride,ActionEffectTileHighlighting, ActionEffectTextOverride) SELECT
'GREAT_PERSON_INDIVIDUAL_ALEXANDER_'||number,
...
INSERT INTO GreatPersonIndividualIconModifiers(GreatPersonIndividualType, OverrideUnitIcon) SELECT
'GREAT_PERSON_INDIVIDUAL_ALEXANDER_'||number,'ICON_UNIT_ALEXANDER_THE_GREAT'
FROM TEMP_ALEXANDER_NUMBERS;


INSERT INTO GreatPersonIndividualBirthModifiers(GreatPersonIndividualType, ModifierId) SELECT
'GREAT_PERSON_INDIVIDUAL_ALEXANDER_'||number,'GREATPERSON_COMBAT_STRENGTH_AOE_MEDIEVAL_LAND'
FROM TEMP_ALEXANDER_NUMBERS UNION SELECT
'GREAT_PERSON_INDIVIDUAL_ALEXANDER_'||number,'GREATPERSON_MOVEMENT_AOE_MEDIEVAL_LAND'
FROM TEMP_ALEXANDER_NUMBERS UNION SELECT
'GREAT_PERSON_INDIVIDUAL_ALEXANDER_'||number,'GREATPERSON_COMBAT_STRENGTH_AOE_CLASSICAL_LAND'
FROM TEMP_ALEXANDER_NUMBERS UNION SELECT
'GREAT_PERSON_INDIVIDUAL_ALEXANDER_'||number,'GREATPERSON_MOVEMENT_AOE_CLASSICAL_LAND'
FROM TEMP_ALEXANDER_NUMBERS;

INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES
('TRAIT_LEADER_TO_WORLDS_END', 'MODIFIER_TRAIT_LEADER_TO_WORLDS_END_GREAT_PERSON_GUARANTEE');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
('MODIFIER_TRAIT_LEADER_TO_WORLDS_END_GREAT_PERSON_GUARANTEE', 'MODIFIER_PLAYER_ADJUST_GREAT_PERSON_GUARANTEE', 0, 0, 0, 'NW_PLAYER_HAS_BUILDING_BASILIKOI_PAIDES', NULL);
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
('MODIFIER_TRAIT_LEADER_TO_WORLDS_END_GREAT_PERSON_GUARANTEE', 'GreatPersonClassType', 'GREAT_PERSON_CLASS_ALEXANDER');
...
-- 虚拟单位（挂靠Trait显示）
INSERT INTO Units(UnitType,Domain,Name,Description,Cost,BaseMoves,BaseSightRange,FormationClass,CanTrain,MustPurchase,TraitType)SELECT
'UNIT_ALEXANDER_THE_GREAT',Domain,'LOC_LEADER_NW_ALEXANDER_NAME','LOC_LEADER_NW_ALEXANDER_DESCRIPTION',Cost,BaseMoves,BaseSightRange,FormationClass,CanTrain,MustPurchase,'TRAIT_UNIT_ALEXANDER_THE_GREAT'
...
INSERT INTO LeaderTraits(LeaderType, TraitType) SELECT
LeaderType, 'TRAIT_UNIT_ALEXANDER_THE_GREAT'
FROM LeaderTraits WHERE TraitType = 'TRAIT_LEADER_TO_WORLDS_END';
...
('DISTRICT_IKANDA', 'MODIFIER_DISTRICT_IKANDA_GRANT_UNIT_IN_CITY');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
('MODIFIER_DISTRICT_IKANDA_GRANT_UNIT_IN_CITY', 'MODIFIER_SINGLE_CITY_GRANT_UNIT_IN_CITY', 1, 1, 0, NULL, NULL);
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
('MODIFIER_DISTRICT_IKANDA_GRANT_UNIT_IN_CITY', 'AllowUniqueOverride', '0'),
('MODIFIER_DISTRICT_IKANDA_GRANT_UNIT_IN_CITY', 'Amount', '1'),
('MODIFIER_DISTRICT_IKANDA_GRANT_UNIT_IN_CITY', 'UnitType', 'UNIT_SPEARMAN');


INSERT INTO DistrictModifiers (DistrictType, ModifierId) VALUES
('DISTRICT_IKANDA', 'MODIFIER_DISTRICT_IKANDA_BUILDING_BARRACKS_YIELD_CHANGE');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
('MODIFIER_DISTRICT_IKANDA_BUILDING_BARRACKS_YIELD_CHANGE', 'MODIFIER_BUILDING_YIELD_CHANGE', 0, 0, 0, NULL, NULL);
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
('MODIFIER_DISTRICT_IKANDA_BUILDING_BARRACKS_YIELD_CHANGE', 'Amount', '1'),
...
INSERT INTO DistrictModifiers (DistrictType, ModifierId) VALUES
('DISTRICT_IKANDA', 'MODIFIER_DISTRICT_IKANDA_BUILDING_STABLE_YIELD_CHANGE');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
('MODIFIER_DISTRICT_IKANDA_BUILDING_STABLE_YIELD_CHANGE', 'MODIFIER_BUILDING_YIELD_CHANGE', 0, 0, 0, NULL, NULL);
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
('MODIFIER_DISTRICT_IKANDA_BUILDING_STABLE_YIELD_CHANGE', 'Amount', '1'),
