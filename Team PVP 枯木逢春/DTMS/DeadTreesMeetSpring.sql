...
DELETE FROM TraitModifiers WHERE TraitType = 'TRAIT_LEADER_ANTIQUES_AND_PARKS' AND ModifierId IN ('WENMEI_YULINMEILI_TEAMPVP','TRAIT_WILD_CARD_FAVOR');
...
('TRAIT_LEADER_ANTIQUES_AND_PARKS', 'MODIFIER_TRAIT_LEADER_ANTIQUES_AND_PARKS_BUILDER_ABILITY');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
('MODIFIER_TRAIT_LEADER_ANTIQUES_AND_PARKS_BUILDER_ABILITY', 'MODIFIER_PLAYER_UNITS_GRANT_ABILITY', 0, 0, 0, 'REQS_NW_PLAYER_HAS_NOT_CIVIC_CONSERVATION', NULL);
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
('MODIFIER_TRAIT_LEADER_ANTIQUES_AND_PARKS_BUILDER_ABILITY', 'AbilityType', 'ABILITY_NW_CANNOT_PLANT_FOREST_BUT_ADJACENT_PRESERVE');
...
('REQS_NW_PLAYER_HAS_NOT_CIVIC_CONSERVATION', 'REQUIREMENTSET_TEST_ALL'),
('REQS_NW_UNIT_NOT_ADJACENT_PRESERVE', 'REQUIREMENTSET_TEST_ALL');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
('REQS_NW_PLAYER_HAS_NOT_CIVIC_CONSERVATION', 'REQ_NW_PLAYER_HAS_NOT_CIVIC_CONSERVATION'),
('REQS_NW_UNIT_NOT_ADJACENT_PRESERVE', 'REQ_NW_UNIT_NOT_ADJACENT_PRESERVE');
-- Requirements
INSERT INTO Requirements (RequirementId, RequirementType, Inverse) VALUES
('REQ_NW_PLAYER_HAS_NOT_CIVIC_CONSERVATION', 'REQUIREMENT_PLAYER_HAS_CIVIC', 1),
('REQ_NW_UNIT_NOT_ADJACENT_PRESERVE', 'REQUIREMENT_PLOT_ADJACENT_DISTRICT_TYPE_MATCHES', 1);
INSERT INTO RequirementArguments (RequirementId, Name, Value) VALUES
('REQ_NW_PLAYER_HAS_NOT_CIVIC_CONSERVATION', 'CivicType', 'CIVIC_CONSERVATION'),
...
INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES
('TRAIT_LEADER_ROOSEVELT_COROLLARY', 'MODIFIER_TRAIT_LEADER_ROOSEVELT_COROLLARY_ADD_ROUTE');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
('MODIFIER_TRAIT_LEADER_ROOSEVELT_COROLLARY_ADD_ROUTE', 'MODIFIER_PLAYER_DISTRICTS_ADJUST_TRADE_ROUTE_CAPACITY', 0, 0, 0, NULL, 'NW_DISTRICT_IS_DISTRICT_DIPLOMATIC_QUARTER_OR_DISTRICT_GOVERNMENT');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
('MODIFIER_TRAIT_LEADER_ROOSEVELT_COROLLARY_ADD_ROUTE', 'Amount', '1');

-- RequirementSets
INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES
('NW_DISTRICT_IS_DISTRICT_DIPLOMATIC_QUARTER_OR_DISTRICT_GOVERNMENT', 'REQUIREMENTSET_TEST_ANY');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
('NW_DISTRICT_IS_DISTRICT_DIPLOMATIC_QUARTER_OR_DISTRICT_GOVERNMENT', 'NW_DISTRICT_IS_DISTRICT_GOVERNMENT_REQUIREMENT'),
('NW_DISTRICT_IS_DISTRICT_DIPLOMATIC_QUARTER_OR_DISTRICT_GOVERNMENT', 'NW_DISTRICT_IS_DISTRICT_DIPLOMATIC_QUARTER_REQUIREMENT');
