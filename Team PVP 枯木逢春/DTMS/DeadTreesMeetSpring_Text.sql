...
VALUES -- FE
       ...
       ('LOC_TRAIT_LEADER_MUTAL_DESCRIPTION', 'zh_Hans_CN',
        '[ICON_Capital] 首都6单元格范围内的非首都城市所有产出+5%。其他非首都城市的所有产出-10%。[ICON_Capital] 首都6单元格范围内的单位+2 [ICON_Strength] 战斗力。当前回合数恰能被10整除时，一次性获得52 [ICON_Faith] 信仰值。'),
       ...
       -- 祖鲁
       ('LOC_TRAIT_LEADER_AMABUTHO_DESCRIPTION', 'zh_Hans_CN',
        '人文主义市政后可组建军团；城市化市政后可组建军队。军团和军队的 [ICON_STRENGTH] 基础战斗力分别额外+1和+3。首次建成伊坎达及其建筑时提供一个枪兵，相同建筑不会重复提供此加成。'),
       ('LOC_DISTRICT_IKANDA_DESCRIPTION', 'zh_Hans_CN',
        '祖鲁特色区域，替代军营。提供 +1 [ICON_Housing] 住房。满足市政或科技先决条件后即可创建军团和军队。伊坎达中的建筑+1 [ICON_SCIENCE] 科技值。城市中的兵营额外+1 [ICON_CULTURE] 文化值，马厩+1 [ICON_SCIENCE] 科技值。可加快军团和军队的创建速度。'),
       ...
       ('LOC_TRAIT_LEADER_GIFTS_FOR_TLATOANI_DESCRIPTION', 'zh_Hans_CN',
        '其领土中的奢侈品资源为额外2座城市提供1点 [ICON_Amenities] 宜居度。陆地单位进攻时，从每种已建立改良设施的陆地奢侈品资源获得+1 [ICON_Strength] 战斗力，至多通过这种方式获得+4 [ICON_Strength] 战斗力。'),
       ...
       -- 高棉
       ('LOC_TRAIT_CIVILIZATION_KHMER_BARAYS_EXPANSION2_DESCRIPTION', 'zh_Hans_CN',
        '水渠+1 [ICON_AMENITIES] 宜居度。每有1点 [ICON_CITIZEN] 人口，则+0.8 [ICON_FAITH] 信仰值、+0.1 [ICON_Culture] 文化值。农场与水渠相邻时，提供的 [ICON_FOOD] 食物+1；与圣地相邻时，提供的 [ICON_FAITH] 信仰值+1。'),
       ...
       ('LOC_TRAIT_CIVILIZATION_LAST_PROPHET_DESCRIPTION', 'zh_Hans_CN',
        '阿拉伯的圣城提供+1 [ICON_TRADEROUTE] 贸易路线容量，且圣城训练的宗教单位具有一次额外的传教次数。以阿拉伯圣城为终点的 [ICON_TRADEROUTE] 国际贸易路线为起源城市+2 [ICON_GOLD] 金币，为阿拉伯+2 [ICON_FAITH] 信仰值。当倒数第二个 [ICON_GreatProphet] 预言家被招募后（如果您尚未获得 [ICON_GreatProphet] 大预言家），自动获得最后一个大预言家。每座信奉阿拉伯宗教的外国城市+1 [ICON_Science] 科技值。阿拉伯的圣地建造完成后，圣地每回合获得2点额外 [ICON_Faith] 信仰值（不能被翻倍）。拥有图书馆的城市可以使用 [ICON_Faith] 信仰值购买学院建筑。'),
