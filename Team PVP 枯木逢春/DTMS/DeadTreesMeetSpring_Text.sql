...
REPLACE INTO LocalizedText ( Tag, Language, Text )
 VALUES -- FE
        ...
        ( 'LOC_TRAIT_LEADER_MUTAL_DESCRIPTION', 'zh_Hans_CN',
          '[ICON_Capital] 首都6单元格范围内的非首都城市所有产出+5%。其他非首都城市的所有产出-10%。[ICON_Capital] 首都6单元格范围内的单位+2 [ICON_Strength] 战斗力。从玛雅长纪历的第零伯克盾开始，每经历2个伯克盾，一次性获得52 [ICON_Faith] 信仰值（联机速度下）。[NEWLINE][NEWLINE]玛雅长纪历第0伯克盾：公元前2720年（联机速度下第17回合）[NEWLINE]玛雅长纪历第2伯克盾：公元前1931年（联机速度下第26回合）[NEWLINE]玛雅长纪历第4伯克盾：公元前1143年（联机速度下第37回合）[NEWLINE]玛雅长纪历第6伯克盾：公元前354年（联机速度下第53回合）[NEWLINE]玛雅长纪历第8伯克盾：公元435年（联机速度下第70回合）[NEWLINE]玛雅长纪历第10伯克盾：公元1224年（联机速度下第92回合）[NEWLINE]玛雅长纪历第12伯克盾：公元2012年（联机速度下第217回合）' ),
 ...
 REPLACE INTO LocalizedText( Tag, Language, Text )
  SELECT Tag, 'zh_Hans_CN', Text
   ...
   WHERE EXISTS (SELECT 1
                   FROM LocalizedText
                  WHERE Tag = 'LOC_GREAT_PERSON_INDIVIDUAL_IMHOTEPI_NAME' AND Text = '号码菌');
