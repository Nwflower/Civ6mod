--	FILE: Civilization_Douglas_Unit.sql
--  VERSION: 1
--  Author: Nwflower
--  Spicial Thanks: Uni
--	Copyright (c) 2025.
...
VALUES ('UNIT_NIMIZI_HANGMU', 'KIND_UNIT');

INSERT INTO TypeTags(Type, Tag)
SELECT 'UNIT_NIMIZI_HANGMU', Tag
FROM TypeTags
WHERE Type = 'UNIT_AIRCRAFT_CARRIER';

INSERT INTO UnitAiInfos(UnitType, AiType)
SELECT 'UNIT_NIMIZI_HANGMU', AiType
FROM UnitAiInfos
WHERE UnitType = 'UNIT_AIRCRAFT_CARRIER';

-- 单位是否替代原型单位
INSERT INTO UnitReplaces (civuniqueunittype, replacesunittype)
VALUES ('UNIT_NIMIZI_HANGMU', 'UNIT_AIRCRAFT_CARRIER');
...
SELECT 'UNIT_NIMIZI_HANGMU',                 -- 类型
       'LOC_UNIT_NIMIZI_HANGMU_NAME',        -- 名称
       BaseSightRange,                            --视野
       BaseMoves,                                 -- 移动力
       70,                                    -- 近战力
       RangedCombat,                              -- 远程力
       ...
       'LOC_UNIT_NIMIZI_HANGMU_DESCRIPTION', -- 描述文本
       Flavor,
       CanCapture,                                -- 可以俘虏平民单位
       CanRetreatWhenCaptured,                    -- 被俘虏时传送回最近城市
       'TRAIT_UNIT_NIMIZI_HANGMU',           -- 绑定特性
