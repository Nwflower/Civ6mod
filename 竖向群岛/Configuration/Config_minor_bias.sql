...
DELETE FROM StartBiasTerrains WHERE TerrainType="TERRAIN_DESERT" AND CivilizationType != "CIVILIZATION_MALI";
DELETE FROM StartBiasTerrains WHERE TerrainType="TERRAIN_DESERT_HILLS" AND CivilizationType != "CIVILIZATION_MALI";