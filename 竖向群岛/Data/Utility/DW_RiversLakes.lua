...
function AddRivers(args)
	...
	riverSourceRangeDefault = 2;
	seaWaterRangeDefault = 1;
	plotsPerRiverEdge = 1;
	
	print("Team PVP Map Generation - Adding Rivers");
	...
	for iPass, passCondition in ipairs(passConditions) do
		...
		if (iPass <= 2) then
			...
			riverSourceRange = riverSourceRange;--(riverSourceRangeDefault / 2);
			seaWaterRange = seaWaterRange;--(seaWaterRangeDefault / 2);
		end
