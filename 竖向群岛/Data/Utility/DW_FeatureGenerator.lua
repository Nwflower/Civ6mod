...
function DW_FeatureGenerator.Create(args)
	...
	local iReefPercent = args.iReefPercent or 10;
...
--
	...
	local instance = {
		...
		iJungleBottom = iEquator - (90 * gridHeight / 180);
		iJungleTop = iEquator + (90 * gridHeight / 180);
...
--	local hills_Persent = 0.70		-- 优先给丘陵添加森林
