...
DELETE FROM Types WHERE Type IN (
        'GREAT_PERSON_INDIVIDUAL_NW_SCIENTIST_CLASSICAL_1',
        'GREAT_PERSON_INDIVIDUAL_NW_SCIENTIST_MEDIEVAL_1',
        'GREAT_PERSON_INDIVIDUAL_NW_SCIENTIST_MEDIEVAL_2',
        'GREAT_PERSON_INDIVIDUAL_NW_SCIENTIST_RENAISSANCE_1',
        'GREAT_PERSON_INDIVIDUAL_NW_SCIENTIST_MODERN_1',
        ...
        'GREAT_PERSON_INDIVIDUAL_ABU_AL_QASIM_AL_ZAHRAWI',
        'GREAT_PERSON_INDIVIDUAL_DMITRI_MENDELEEV',
        'GREAT_PERSON_INDIVIDUAL_ALBERT_EINSTEIN',
        'GREAT_PERSON_INDIVIDUAL_ALFRED_NOBEL');