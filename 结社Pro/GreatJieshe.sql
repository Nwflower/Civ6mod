...
-- 地脉改任意
INSERT OR REPLACE INTO Improvement_ValidResources (ResourceType, ImprovementType) VALUES 
...
-- 城邦改良
INSERT OR REPLACE INTO Improvement_ValidResources (ResourceType, ImprovementType) SELECT
