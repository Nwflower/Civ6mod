...
('MODIFIER_GOVERNMENT_XINGSHENGFENQUAN_YIELD', 'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_MODIFIER');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
('MODIFIER_GOVERNMENT_XINGSHENGFENQUAN_YIELD', 'Amount', '3,3,3,3,3'),
...
SELECT 'GOVERNMENT_GUIZUGONGHE',
       ...
       'CIVIC_MERCENARIES',
       'LOC_GOVT_INHERENT_BONUS_GUIZUGONGHE',
...
INSERT INTO GovernmentModifiers (GovernmentType, ModifierId) VALUES
('GOVERNMENT_GUIZUGONGHE', 'MODIFIER_GOVERNMENT_GUIZUGONGHE_UNITS_GOLD');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
('MODIFIER_GOVERNMENT_GUIZUGONGHE_UNITS_GOLD', 'MODIFIER_NW_PLAYER_UNITS_ADJUST_WONDER_YIELD_CHANGE', 0, 0, 0, NULL, NULL);
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
('MODIFIER_GOVERNMENT_GUIZUGONGHE_UNITS_GOLD', 'Amount', '4'),
('MODIFIER_GOVERNMENT_GUIZUGONGHE_UNITS_GOLD', 'YieldType', 'YIELD_GOLD');
-- Custom ModifierType
INSERT INTO Types (Type, Kind) VALUES
('MODIFIER_NW_PLAYER_UNITS_ADJUST_WONDER_YIELD_CHANGE', 'KIND_MODIFIER');
INSERT INTO DynamicModifiers (ModifierType, CollectionType, EffectType) VALUES
('MODIFIER_NW_PLAYER_UNITS_ADJUST_WONDER_YIELD_CHANGE', 'COLLECTION_PLAYER_UNITS', 'EFFECT_ADJUST_PLAYER_YIELD_CHANGE');
