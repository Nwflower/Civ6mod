...
INSERT INTO Modifiers ( ModifierId, ModifierType, OwnerRequirementSetId,SubjectRequirementSetId )
VALUES ( 'MODIFIER_TRAIT_LEADER_MEDITERRANEAN_SCIENCE', 'MODIFIER_PLAYER_DISTRICTS_ADJUST_YIELD_CHANGE', 'NW_PLAYER_HAS_CIVIC_CODE_OF_LAWS','NW_DTMS_REQS_PLOTS_NEXT_RIVER' );
INSERT INTO ModifierArguments ( ModifierId, Name, Value )
...
INSERT INTO Modifiers ( ModifierId, ModifierType, OwnerRequirementSetId, SubjectRequirementSetId )
VALUES ( 'MODIFIER_TRAIT_LEADER_RAMSES_PRODUCTION', 'MODIFIER_PLAYER_DISTRICTS_ADJUST_YIELD_CHANGE', 'NW_PLAYER_HAS_CIVIC_CODE_OF_LAWS','NW_DTMS_REQS_PLOTS_NEXT_RIVER' );
INSERT INTO ModifierArguments ( ModifierId, Name, Value )
...
INSERT INTO Modifiers ( ModifierId, ModifierType, OwnerRequirementSetId, SubjectRequirementSetId )
VALUES ( 'MODIFIER_TRAIT_LEADER_CLEOPATRA_ALT_GOLD', 'MODIFIER_PLAYER_DISTRICTS_ADJUST_YIELD_CHANGE', 'NW_PLAYER_HAS_CIVIC_CODE_OF_LAWS','NW_DTMS_REQS_PLOTS_NEXT_RIVER' );
INSERT INTO ModifierArguments ( ModifierId, Name, Value )
VALUES ( 'MODIFIER_TRAIT_LEADER_CLEOPATRA_ALT_GOLD', 'Amount', 3 ),
       ( 'MODIFIER_TRAIT_LEADER_CLEOPATRA_ALT_GOLD', 'YieldType', 'YIELD_GOLD' );

INSERT INTO TraitModifiers ( TraitType, ModifierId )
VALUES ( 'TRAIT_LEADER_MEDITERRANEAN', 'MODIFIER_TRAIT_LEADER_MEDITERRANEAN_SCIENCE_SPHINX' );
INSERT INTO Modifiers ( ModifierId, ModifierType, OwnerRequirementSetId,SubjectRequirementSetId )
VALUES ( 'MODIFIER_TRAIT_LEADER_MEDITERRANEAN_SCIENCE_SPHINX', 'MODIFIER_PLAYER_ADJUST_PLOT_YIELD', 'NW_PLAYER_HAS_CIVIC_CODE_OF_LAWS','NW_DTMS_REQS_PLOTS_NEXT_RIVER_SPHINX' );
INSERT INTO ModifierArguments ( ModifierId, Name, Value )
VALUES ( 'MODIFIER_TRAIT_LEADER_MEDITERRANEAN_SCIENCE_SPHINX', 'Amount', 1 ),
       ( 'MODIFIER_TRAIT_LEADER_MEDITERRANEAN_SCIENCE_SPHINX', 'YieldType', 'YIELD_SCIENCE' );

INSERT INTO TraitModifiers ( TraitType, ModifierId )
VALUES ( 'TRAIT_LEADER_RAMSES', 'MODIFIER_TRAIT_LEADER_RAMSES_PRODUCTION_SPHINX' );
INSERT INTO Modifiers ( ModifierId, ModifierType, OwnerRequirementSetId, SubjectRequirementSetId )
VALUES ( 'MODIFIER_TRAIT_LEADER_RAMSES_PRODUCTION_SPHINX', 'MODIFIER_PLAYER_ADJUST_PLOT_YIELD', 'NW_PLAYER_HAS_CIVIC_CODE_OF_LAWS','NW_DTMS_REQS_PLOTS_NEXT_RIVER_SPHINX' );
INSERT INTO ModifierArguments ( ModifierId, Name, Value )
VALUES ( 'MODIFIER_TRAIT_LEADER_RAMSES_PRODUCTION_SPHINX', 'Amount', 1 ),
       ( 'MODIFIER_TRAIT_LEADER_RAMSES_PRODUCTION_SPHINX', 'YieldType', 'YIELD_PRODUCTION' );

INSERT INTO TraitModifiers ( TraitType, ModifierId )
VALUES ( 'TRAIT_LEADER_CLEOPATRA_ALT', 'MODIFIER_TRAIT_LEADER_CLEOPATRA_ALT_GOLD_SPHINX' );
INSERT INTO Modifiers ( ModifierId, ModifierType, OwnerRequirementSetId, SubjectRequirementSetId )
VALUES ( 'MODIFIER_TRAIT_LEADER_CLEOPATRA_ALT_GOLD_SPHINX', 'MODIFIER_PLAYER_ADJUST_PLOT_YIELD', 'NW_PLAYER_HAS_CIVIC_CODE_OF_LAWS','NW_DTMS_REQS_PLOTS_NEXT_RIVER_SPHINX' );
INSERT INTO ModifierArguments ( ModifierId, Name, Value )
VALUES ( 'MODIFIER_TRAIT_LEADER_CLEOPATRA_ALT_GOLD_SPHINX', 'Amount', 3 ),
       ( 'MODIFIER_TRAIT_LEADER_CLEOPATRA_ALT_GOLD_SPHINX', 'YieldType', 'YIELD_GOLD' );

INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES
('NW_DTMS_REQS_PLOTS_NEXT_RIVER_SPHINX', 'REQUIREMENTSET_TEST_ALL');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
('NW_DTMS_REQS_PLOTS_NEXT_RIVER_SPHINX', 'NW_DTMS_REQ_PLOTS_NEXT_RIVER'),
('NW_DTMS_REQS_PLOTS_NEXT_RIVER_SPHINX', 'NW_DTMS_REQ_PLOTS_IS_IMPROVEMENT_SPHINX');
INSERT INTO Requirements (RequirementId, RequirementType) VALUES
('NW_DTMS_REQ_PLOTS_IS_IMPROVEMENT_SPHINX', 'REQUIREMENT_PLOT_IMPROVEMENT_TYPE_MATCHES');
INSERT INTO RequirementArguments (RequirementId, Name, Value) VALUES
('NW_DTMS_REQ_PLOTS_IS_IMPROVEMENT_SPHINX', 'ImprovementType', 'IMPROVEMENT_SPHINX');
...
('TRAIT_CIVILIZATION_INDUSTRIAL_REVOLUTION', 'MODIFIER_TRAIT_CIVILIZATION_INDUSTRIAL_REVOLUTION_VIS');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
('MODIFIER_TRAIT_CIVILIZATION_INDUSTRIAL_REVOLUTION_VIS', 'MODIFIER_PLAYER_GRANT_FREE_RESOURCE_VISIBILITY', 0, 0, 0, 'NW_PLAYER_HAS_CIVIC_FEUDALISM', NULL);
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
('MODIFIER_TRAIT_CIVILIZATION_INDUSTRIAL_REVOLUTION_VIS', 'ResourceType', 'RESOURCE_COAL');

INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES
('TRAIT_CIVILIZATION_INDUSTRIAL_REVOLUTION', 'TRAIT_CIVILIZATION_INDUSTRIAL_REVOLUTION_EXTRA_ACCUMULATION');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
('TRAIT_CIVILIZATION_INDUSTRIAL_REVOLUTION_EXTRA_ACCUMULATION', 'MODIFIER_PLAYER_CITIES_ADJUST_EXTRA_ACCUMULATION', 0, 0, 0, NULL, NULL);
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
('TRAIT_CIVILIZATION_INDUSTRIAL_REVOLUTION_EXTRA_ACCUMULATION', 'Amount', '2');
...
UPDATE Projects
   SET Cost='128', CostProgressionParam1='0'
...
VALUES ( 'MODIFIER_TRAIT_LEADER_MAGNIFICENCES_DIS', 'DistrictType', 'DISTRICT_THEATER' ),
       ( 'MODIFIER_TRAIT_LEADER_MAGNIFICENCES_DIS', 'CivicType', 'CIVIC_FOREIGN_TRADE' );
...
INSERT INTO Modifiers ( ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId )
VALUES ( 'MODIFIER_TRAIT_LEADER_KANDAKE_OF_MEROE_DISTRICT_PRODUCTION_MODIFIER', 'MODIFIER_PLAYER_CITIES_ADJUST_DISTRICT_PRODUCTION_MODIFIER', 0, 0, 0, 'NW_PLAYER_HAS_CIVIC_STATE_WORKFORCE', 'CITY_HAS_0_SPECIALTY_DISTRICTS_REQUIREMENTS' );
INSERT INTO ModifierArguments ( ModifierId, Name, Value )
...
SELECT 'NW_DISTRICT_IS_NEXT_RIVER_' || DistrictType, 'NW_DISTRICT_IS_' || DistrictType || '_REQUIREMENT'
  FROM Districts
 UNION
SELECT 'NW_DISTRICT_IS_NEXT_RIVER_' || DistrictType, 'REQ_NW_DTMS_PLOT_FEATURE_IS_FLOODPLAINS'
  FROM Districts;

-- Requirements
INSERT INTO Requirements (RequirementId, RequirementType) VALUES
('REQ_NW_DTMS_PLOT_FEATURE_IS_FLOODPLAINS', 'REQUIREMENT_PLOT_FEATURE_TAG_MATCHES');
INSERT INTO RequirementArguments (RequirementId, Name, Value) VALUES
('REQ_NW_DTMS_PLOT_FEATURE_IS_FLOODPLAINS', 'Tag', 'CLASS_FLOODPLAINS');
