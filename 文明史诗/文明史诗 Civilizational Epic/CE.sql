...
'TRAIT_LEADER_CITADEL_CIVILIZATION', 'MODFEAT_AUSTRALIA_VALID_BUILD_'||UnitType
FROM Units;
...
'MODFEAT_AUSTRALIA_VALID_BUILD_'||UnitType, 'MODIFIER_NW_DTMS_PLAYER_CITIES_ADJUST_VALID_UNIT_BUILD', 0, 1, 0, NULL, 'REQS_NW_DTMS_ADJACENT_CITY_'||UnitType
FROM Units;
INSERT INTO ModifierArguments (ModifierId, Name, Value) SELECT
'MODFEAT_AUSTRALIA_VALID_BUILD_'||UnitType, 'UnitType', UnitType
FROM Units;
INSERT INTO Types (Type, Kind) VALUES
('MODIFIER_NW_DTMS_PLAYER_CITIES_ADJUST_VALID_UNIT_BUILD', 'KIND_MODIFIER');
INSERT INTO DynamicModifiers (ModifierType, CollectionType, EffectType) VALUES
('MODIFIER_NW_DTMS_PLAYER_CITIES_ADJUST_VALID_UNIT_BUILD', 'COLLECTION_PLAYER_CITIES', 'EFFECT_ADJUST_PLAYER_VALID_UNIT_BUILD');
INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) SELECT
'REQS_NW_DTMS_ADJACENT_CITY_'||UnitType, 'REQUIREMENTSET_TEST_ALL'
FROM Units;
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) SELECT
'REQS_NW_DTMS_ADJACENT_CITY_'||UnitType, 'REQ_NW_DTMS_ADJACENT_CITY_'||UnitType
FROM Units;
INSERT INTO Requirements (RequirementId, RequirementType) SELECT
'REQ_NW_DTMS_ADJACENT_CITY_'||UnitType, 'REQUIREMENT_PLOT_ADJACENT_UNIT_TYPE_MATCHES'
FROM Units;
INSERT INTO RequirementArguments (RequirementId, Name, Value) SELECT
'REQ_NW_DTMS_ADJACENT_CITY_'||UnitType, 'MaxRange', '1'
FROM Units UNION SELECT
'REQ_NW_DTMS_ADJACENT_CITY_'||UnitType, 'MinRange', '0'
FROM Units UNION SELECT
'REQ_NW_DTMS_ADJACENT_CITY_'||UnitType, 'UnitType', UnitType
FROM Units;

INSERT INTO TraitModifiers (TraitType, ModifierId) SELECT
'TRAIT_LEADER_CITADEL_CIVILIZATION', 'MODFEAT_AUSTRALIA_BUILD_PRODUCTION_'||UnitType
FROM Units WHERE TraitType IS NOT NULL AND TraitType IS NOT 'TRAIT_CIVILIZATION_UNIT_DIGGER';
INSERT INTO Modifiers (ModifierId, ModifierType) SELECT
'MODFEAT_AUSTRALIA_BUILD_PRODUCTION_'||UnitType, 'MODIFIER_PLAYER_UNITS_ADJUST_UNIT_PRODUCTION'
FROM Units WHERE TraitType IS NOT NULL AND TraitType IS NOT 'TRAIT_CIVILIZATION_UNIT_DIGGER';
INSERT INTO ModifierArguments (ModifierId, Name, Value) SELECT
'MODFEAT_AUSTRALIA_BUILD_PRODUCTION_'||UnitType, 'UnitType', UnitType
FROM Units WHERE TraitType IS NOT NULL AND TraitType IS NOT 'TRAIT_CIVILIZATION_UNIT_DIGGER' UNION  SELECT
'MODFEAT_AUSTRALIA_BUILD_PRODUCTION_'||UnitType, 'Amount', 20
FROM Units WHERE TraitType IS NOT NULL AND TraitType IS NOT 'TRAIT_CIVILIZATION_UNIT_DIGGER';
...
-- 对圣地及其建筑+25% [ICON_Production] 生产力。首次建造寺庙时获得一个免费的遗物。允许城市使用 [ICON_Production] 生产力建造宗教单位，生产宗教单位时+100% [ICON_Production] 生产力。
INSERT INTO TraitModifiers ( TraitType, ModifierId )
VALUES ( 'TRAIT_LEADER_RELIGIOUS_CONVERT', 'TRAIT_LEADER_RELIGIOUS_CONVERT_GRANT_A_RELIC' );
INSERT INTO Modifiers ( ModifierId, ModifierType, SubjectRequirementSetId, Permanent )
VALUES ( 'TRAIT_LEADER_RELIGIOUS_CONVERT_GRANT_A_RELIC', 'MODIFIER_PLAYER_GRANT_RELIC', 'NW_PLAYER_HAS_BUILDING_SHRINE', 1 );
INSERT INTO ModifierArguments ( ModifierId, Name, Value )
VALUES ( 'TRAIT_LEADER_RELIGIOUS_CONVERT_GRANT_A_RELIC', 'Amount', '1' );
...
INSERT INTO TraitModifiers ( TraitType, ModifierId )
VALUES ( 'TRAIT_LEADER_RELIGIOUS_CONVERT', 'TRAIT_LEADER_RELIGIOUS_CONVERT_DP' );
INSERT INTO Modifiers ( ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId )
VALUES ( 'TRAIT_LEADER_RELIGIOUS_CONVERT_DP', 'MODIFIER_PLAYER_CITIES_ADJUST_DISTRICT_PRODUCTION', 0, 0, 0, NULL, NULL );
INSERT INTO ModifierArguments ( ModifierId, Name, Value )
VALUES ( 'TRAIT_LEADER_RELIGIOUS_CONVERT_DP', 'Amount', '25' ),
       ( 'TRAIT_LEADER_RELIGIOUS_CONVERT_DP', 'DistrictType', 'DISTRICT_HOLY_SITE' );

INSERT INTO TraitModifiers ( TraitType, ModifierId )
VALUES ( 'TRAIT_LEADER_RELIGIOUS_CONVERT', 'TRAIT_LEADER_RELIGIOUS_CONVERT_BP' );
INSERT INTO Modifiers ( ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId )
VALUES ( 'TRAIT_LEADER_RELIGIOUS_CONVERT_BP', 'MODIFIER_PLAYER_CITIES_ADJUST_BUILDING_PRODUCTION', 0, 0, 0, NULL, NULL );
INSERT INTO ModifierArguments ( ModifierId, Name, Value )
VALUES ( 'TRAIT_LEADER_RELIGIOUS_CONVERT_BP', 'Amount', '25' ),
       ( 'TRAIT_LEADER_RELIGIOUS_CONVERT_BP', 'DistrictType', 'DISTRICT_HOLY_SITE' );


UPDATE Units
   SET MustPurchase = 0, CanTrain = 0
 WHERE ReligiousStrength > 0;
INSERT INTO GameModifiers( ModifierId )
VALUES ( 'GAME_NW_ALL_CITIES_ENABLE_UNIT_FAITH_PURCHASE_CLASS_RELIGIOUS' );
INSERT INTO Modifiers ( ModifierId, ModifierType )
VALUES ( 'GAME_NW_ALL_CITIES_ENABLE_UNIT_FAITH_PURCHASE_CLASS_RELIGIOUS', 'MODIFIER_NW_ALL_CITIES_ENABLE_UNIT_FAITH_PURCHASE' );
INSERT INTO ModifierArguments ( ModifierId, Name, Value )
VALUES ( 'GAME_NW_ALL_CITIES_ENABLE_UNIT_FAITH_PURCHASE_CLASS_RELIGIOUS', 'Tag', 'CLASS_RELIGIOUS' );
INSERT INTO Types ( Type, Kind )
VALUES ( 'MODIFIER_NW_ALL_CITIES_ENABLE_UNIT_FAITH_PURCHASE', 'KIND_MODIFIER' );
INSERT INTO DynamicModifiers ( ModifierType, CollectionType, EffectType )
VALUES ( 'MODIFIER_NW_ALL_CITIES_ENABLE_UNIT_FAITH_PURCHASE', 'COLLECTION_ALL_CITIES', 'EFFECT_ENABLE_UNIT_FAITH_PURCHASE' );

INSERT INTO TraitModifiers ( TraitType, ModifierId )
SELECT 'TRAIT_LEADER_RELIGIOUS_CONVERT', 'TRAIT_LEADER_RELIGIOUS_CONVERT_UB_' || UnitType
  FROM Units
 WHERE ReligiousStrength > 0;
INSERT INTO Modifiers ( ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId )
SELECT 'TRAIT_LEADER_RELIGIOUS_CONVERT_UB_' || UnitType, 'MODIFIER_PLAYER_ADJUST_VALID_UNIT_BUILD', 0, 0, 0, NULL, NULL
  FROM Units
 WHERE ReligiousStrength > 0;
INSERT INTO ModifierArguments ( ModifierId, Name, Value )
SELECT 'TRAIT_LEADER_RELIGIOUS_CONVERT_UB_' || UnitType, 'UnitType', UnitType
  FROM Units
 WHERE ReligiousStrength > 0;

INSERT INTO TraitModifiers ( TraitType, ModifierId )
SELECT 'TRAIT_LEADER_RELIGIOUS_CONVERT', 'TRAIT_LEADER_RELIGIOUS_CONVERT_UP_' || UnitType
  FROM Units
 WHERE ReligiousStrength > 0;
INSERT INTO Modifiers ( ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId )
SELECT 'TRAIT_LEADER_RELIGIOUS_CONVERT_UP_' || UnitType, 'MODIFIER_PLAYER_CITIES_ADJUST_UNIT_PRODUCTION', 0, 0, 0, NULL,
       NULL
  FROM Units
 WHERE ReligiousStrength > 0;
INSERT INTO ModifierArguments ( ModifierId, Name, Value )
SELECT 'TRAIT_LEADER_RELIGIOUS_CONVERT_UP_' || UnitType, 'UnitType', UnitType
  FROM Units
 WHERE ReligiousStrength > 0
 UNION
SELECT 'TRAIT_LEADER_RELIGIOUS_CONVERT_UP_' || UnitType, 'Amount', 100
  FROM Units
 WHERE ReligiousStrength > 0;
...
DELETE
  FROM TraitModifiers
 WHERE TraitType = 'TRAIT_LEADER_GENGHIS_KHAN_ABILITY' AND ModifierId = 'TRAIT_CAVALRY_CAPTURE_CAVALRY';

UPDATE TraitModifiers
   SET TraitType = 'TRAIT_LEADER_GENGHIS_KHAN_ABILITY'
 WHERE TraitType = 'TRAIT_CIVILIZATION_MONGOLIAN_ORTOO' AND ModifierId = 'TRAIT_EACH_DIPLO_VISIBILITY_COMBAT_MODIFIER';
UPDATE ModifierArguments
   SET Value='1'
 WHERE ModifierId = 'TRAIT_EACH_DIPLO_VISIBILITY_COMBAT_MODIFIER' AND Name = 'Amount';
UPDATE Modifiers
   SET SubjectRequirementSetId = 'NW_REQS_UNIT_IS_CAVALRY'
 WHERE ModifierId = 'TRAIT_EACH_DIPLO_VISIBILITY_COMBAT_MODIFIER';

-- RequirementSets
INSERT INTO RequirementSets ( RequirementSetId, RequirementSetType )
VALUES ( 'NW_REQS_UNIT_IS_CAVALRY', 'REQUIREMENTSET_TEST_ANY' );
INSERT INTO RequirementSetRequirements ( RequirementSetId, RequirementId )
VALUES ( 'NW_REQS_UNIT_IS_CAVALRY', 'NW_REQ_UNIT_IS_CLASS_LIGHT_CAVALRY' ),
       ( 'NW_REQS_UNIT_IS_CAVALRY', 'NW_REQ_UNIT_IS_CLASS_HEAVY_CAVALRY' ),
       ( 'NW_REQS_UNIT_IS_CAVALRY', 'NW_REQ_UNIT_IS_CLASS_RANGED_CAVALRY' );
-- Requirements
INSERT INTO Requirements ( RequirementId, RequirementType )
VALUES ( 'NW_REQ_UNIT_IS_CLASS_LIGHT_CAVALRY', 'REQUIREMENT_UNIT_TAG_MATCHES' ),
       ( 'NW_REQ_UNIT_IS_CLASS_HEAVY_CAVALRY', 'REQUIREMENT_UNIT_TAG_MATCHES' ),
       ( 'NW_REQ_UNIT_IS_CLASS_RANGED_CAVALRY', 'REQUIREMENT_UNIT_TAG_MATCHES' );
INSERT INTO RequirementArguments ( RequirementId, Name, Value )
VALUES ( 'NW_REQ_UNIT_IS_CLASS_LIGHT_CAVALRY', 'Tag', 'CLASS_LIGHT_CAVALRY' ),
       ( 'NW_REQ_UNIT_IS_CLASS_HEAVY_CAVALRY', 'Tag', 'CLASS_HEAVY_CAVALRY' ),
       ( 'NW_REQ_UNIT_IS_CLASS_RANGED_CAVALRY', 'Tag', 'CLASS_RANGED_CAVALRY' );
