...
VALUES ('UNIT_SCHOLAR', 'KIND_UNIT');

INSERT INTO TypeTags(Type, Tag)
SELECT DISTINCT 'UNIT_SCHOLAR', Tag
FROM TypeTags
WHERE Type IN ('UNIT_ARCHAEOLOGIST','UNIT_NATURALIST');

INSERT INTO UnitAiInfos(UnitType, AiType)
SELECT 'UNIT_SCHOLAR', AiType
FROM UnitAiInfos
...
VALUES ('UNIT_SCHOLAR', 'BUILDING_UNIVERSITY',-1);
...
SELECT 'UNIT_SCHOLAR',                 -- 类型
       'LOC_UNIT_SCHOLAR_NAME',        -- 名称
       BaseSightRange,                            --视野
       2,                                 -- 移动力
       Combat,                                    -- 近战力
       RangedCombat,                              -- 远程力
       ...
       'LOC_UNIT_SCHOLAR_DESCRIPTION', -- 描述文本
       Flavor,
       CanCapture,                                -- 可以俘虏平民单位
       1,                    -- 被俘虏时传送回最近城市
       TraitType,           -- 绑定特性
