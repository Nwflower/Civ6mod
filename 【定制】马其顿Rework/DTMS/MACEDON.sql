...
INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES
('TRAIT_LEADER_TO_WORLDS_END', 'MODIFIER_TRAIT_LEADER_TO_WORLDS_END_GOLD');
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId ) VALUES
('MODIFIER_TRAIT_LEADER_TO_WORLDS_END_GOLD', 'MODIFIER_PLAYER_CITIES_GRANT_YIELD_PER_UNIT_COST', 'NW_PLAYER_HAS_CIVIC_NATIONALISM');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
...
INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES
('TRAIT_LEADER_TO_WORLDS_END', 'MODIFIER_TRAIT_LEADER_TO_WORLDS_END_AB1');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
('MODIFIER_TRAIT_LEADER_TO_WORLDS_END_AB1', 'MODIFIER_NW_PLAYER_GRANT_ABILITY_FOR_TRAINED_UNITS', 0, 0, 0, 'NW_PLAYER_HAS_TECH_MILITARY_SCIENCE', 'NW_CITY_HAS_BUILDING_BASILIKOI_PAIDES');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
('MODIFIER_TRAIT_LEADER_TO_WORLDS_END_AB1', 'AbilityType', 'AB_MODIFIER_MQD_JUNSIXUE');

INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES
('TRAIT_LEADER_TO_WORLDS_END', 'MODIFIER_TRAIT_LEADER_TO_WORLDS_END_AB2');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
('MODIFIER_TRAIT_LEADER_TO_WORLDS_END_AB2', 'MODIFIER_NW_PLAYER_GRANT_ABILITY_FOR_TRAINED_UNITS', 0, 0, 0, 'NW_PLAYER_HAS_CIVIC_NATIONALISM', 'NW_CITY_HAS_BUILDING_BASILIKOI_PAIDES');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
('MODIFIER_TRAIT_LEADER_TO_WORLDS_END_AB2', 'AbilityType', 'AB_MODIFIER_MQD_MZ');

-- Custom ModifierType
INSERT INTO Types (Type, Kind) VALUES
('MODIFIER_NW_PLAYER_GRANT_ABILITY_FOR_TRAINED_UNITS', 'KIND_MODIFIER');
INSERT INTO DynamicModifiers (ModifierType, CollectionType, EffectType) VALUES
('MODIFIER_NW_PLAYER_GRANT_ABILITY_FOR_TRAINED_UNITS', 'COLLECTION_PLAYER_TRAINED_UNITS', 'EFFECT_GRANT_ABILITY');
-- RequirementSets
